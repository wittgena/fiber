# router.locator
## @lineage: bound.router.locator
## @lineage: anchor.registry.router.locator
import re
from typing import Optional, Tuple, Dict, Callable
from urllib.parse import urlparse

from bound.registry.model.cost import get_provider_for_model
from bound.registry.model.config.resolver import config
from bound.registry.model.config.constants import REPLICATE_MODEL_NAME_WITH_ID_LENGTH
