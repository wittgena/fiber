# entry.tracer.tester.chaos.injector
## @lineage: receptor.surface.tracer.tester.chaos.injector
## @lineage: surface.tracer.tester.chaos.injector
## @lineage: surface.tester.chaos.injector
## @lineage: exchange.chaos.injector
## @lineage: dphi.exchange.chaos.injector
from typing import Dict, Any, Callable
from dphi.phase.builder import PhaseBuilder
...
class RpcChaosInjector:
    ...
    def corrupt_ap2_mandate(agent_pub_hex: str, agent_key: Any) -> Dict[str, Any]:
        ...
        return PhaseBuilder.ap2_mandate_params(
