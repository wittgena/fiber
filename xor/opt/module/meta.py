...
from xor.scope.dsp.usage import track_usage
...
from xor.opt.module.base import BaseModule
from xor.opt.callback.base import with_callbacks
from xor.executor.dsp import DSPRunner
...
class Module(BaseModule, metaclass=ProgramMeta):
    ...
    def __call__(self, *args, **kwargs) -> Prediction:
        from xor.scope.dsp.context import thread_local_overrides
    ...
    async def acall(self, *args, **kwargs) -> Prediction:
        from xor.scope.dsp.context import _current_context
