...
from xor.loop.callback import CBEventType, EventPayload
...
if TYPE_CHECKING:
    ...
    from xor.loop.flow.llm.structured_llm import StructuredLLM
...
class LLM(BaseLLM):
    ...
    def structured_predict(
        ...
        **prompt_args: Any,
        ...
        """
        from xor.loop.prog.utils import get_program_for_llm
