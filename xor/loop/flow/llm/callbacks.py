...
from xor.loop.callback import CallbackManager, CBEventType, EventPayload

# dispatcher setup
from xor.loop.inst import get_dispatcher
from xor.loop.inst.events.exception import ExceptionEvent
from xor.loop.inst.span import active_span_id
from xor.loop.inst.events.llm import (
