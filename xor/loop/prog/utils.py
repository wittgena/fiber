...
from xor.loop.flow.llm.llm import LLM, ToolSelection
...
from anchor.inter.bound.prompts.base import BasePromptTemplate
from anchor.inter.bound.types import BasePydanticProgram, Model, PydanticProgramMode
from anchor.inter.bound.base.llms.types import ChatResponse, CompletionResponse
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            from xor.loop.prog.function_program import FunctionCallingProgram
            ...
            from xor.loop.prog.llm_program import (
        ...
        from xor.loop.prog.llm_program import LLMTextCompletionProgram
