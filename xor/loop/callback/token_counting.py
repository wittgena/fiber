# xor.loop.callback.token_counting
...
from xor.loop.callback.pythonically_printing_base_handler import PythonicallyPrintingBaseHandler
...
if TYPE_CHECKING:
    from xor.loop.flow.llm import ChatResponse, CompletionResponse
...
def get_llm_token_counts(
    ...
    from xor.loop.flow.llm import ChatMessage
