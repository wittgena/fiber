...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from atoa.topos.terminal.tmux import (
                TmuxTerminal,
            )
            ...
            from atoa.topos.terminal.subprocess import (
                SubprocessTerminal,
            )
    ...
    if system == "Windows":
        ...
        if _is_tmux_available():
            ...
            from atoa.topos.terminal.subprocess import SubprocessTerminal
            _tmux_warning = (
