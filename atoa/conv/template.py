# atoa.conv.template
## @lineage: agent.atoa.conv.template
## @lineage: atoa.agent.conv.template
## @lineage: atoa.context.conv.template
## @lineage: agent.context.conv.template
## @lineage: gov.frame.reflect.conv.template
## @lineage: agent.loop.reflect.conv.template
## @lineage: meta.flow.reflect.conv.template
## @lineage: meta.reflect.conv.template
## @lineage: gov.conv.reflect.template
## @lineage: meta.ops.agent.reflect.template
## @lineage: xphi.agent.reflect.template
