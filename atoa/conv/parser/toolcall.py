# atoa.conv.parser.toolcall
## @lineage: atoa.gov.context.message.parser.toolcall
## @lineage: atoa.context.gov.message.parser.toolcall
## @lineage: gov.conv.message.parser.toolcall
## @lineage: gov.conv.message.toolcall
## @lineage: gov.conv.message.tool.call
import contextlib
import json
import logging
import re
