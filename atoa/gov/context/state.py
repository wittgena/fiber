...
from atoa.agent.disc.event.llm.observation import (
    AgentErrorEvent,
    ObservationEvent,
...
from atoa.agent.disc.base.workspace import BaseWorkspace
...
from atoa.gov.context.command import (
    StateCommand, 
    TransitionStatus, 
    BlockAction, 
    BlockMessage, 
    ...
    def __setattr__(self, name, value):
        ...
        if old is _sentinel or old != value:
            ...
            if callback is not None and old is not _sentinel:
                try:
                    from atoa.agent.disc.event.conv.state import ConversationStateUpdateEvent
