# atoa.gov.agent.config
## @lineage: gov.sandbox.agent.config
...
from atoa.agent.disc.schema.metadata import SettingsSchema
from atoa.agent.disc.schema.setting import VerificationSettings, export_settings_schema
...
class AgentConfig(SurgeBaseModel):
    ...
    def build_reflector(self) -> ReflectorBase | None:
        ...
        from atoa.agent.disc.schema.reflect import IterativeRefinementConfig
        from atoa.agent.config.reflect import Reflector
