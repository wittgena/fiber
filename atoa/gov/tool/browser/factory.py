...
from atoa.gov.disc.action.tool.schema.browser import BrowserAction, BrowserObservation

if sys.platform == "win32":
    from atoa.gov.tool.browser.window import WindowsBrowserExecutor
else:
    from atoa.gov.tool.browser.executor import BrowserExecutor
