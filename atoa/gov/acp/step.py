...
from eco.fiber.action.message import Message, MessageToolCall, TextContent
...
if TYPE_CHECKING:
    ...
    from atoa.gov.disc.conv import EngineContextProtocol
