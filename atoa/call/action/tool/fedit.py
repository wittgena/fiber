# atoa.call.action.tool.fedit
## @lineage: agent.call.action.tool.fedit
## @lineage: gov.conv.action.tool.fedit
...
from atoa.call.action.definition import DeclaredResources, ActionAnnotations, ActionDefinition
...
class FileEditorTool(ActionDefinition[FileEditorAction, FileEditorObservation]):
    ...
    def create(cls, conv_state: "ConversationState") -> Sequence["FileEditorTool"]:
        from agent.engine.tool.fedit.executor import FileEditorExecutor
