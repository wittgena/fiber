# atoa.disc.schema.setting
## @lineage: atoa.gov.disc.schema.setting
## @lineage: agent.atoa.disc.schema.setting
## @lineage: atoa.agent.disc.schema.setting
...
from eco.fiber.residue.convset import (
...
from atoa.disc.schema.metadata import SettingsSchema, SettingsValueType, SettingsChoiceValue, SettingsChoice
