# atoa.disc.event.llm.action
## @lineage: atoa.gov.disc.event.llm.action
## @lineage: agent.atoa.disc.event.llm.action
## @lineage: atoa.agent.disc.event.llm.action
## @lineage: agent.disc.event.llm.action
from collections.abc import Sequence
from typing import TYPE_CHECKING
from pydantic import Field
from rich.text import Text
from atoa.disc.schema.reflect import ReflectorResult
from eco.fiber.event.base import N_CHAR_PREVIEW, EventID, LLMConvertibleEvent
from eco.fiber.event.types import SourceType, ToolCallID
from eco.fiber.action.message import (
    Message,
    MessageToolCall,
    ReasoningItemModel,
...
from eco.gov.atoa.security.eval import SecurityRisk
from atoa.disc.schema.action import Action
...
class ActionEvent(LLMConvertibleEvent):
    ...
    def visualize(self) -> Text:
        ...
        if self.security_risk != SecurityRisk.UNKNOWN:
