# atoa.disc.event.llm.system
## @lineage: atoa.gov.disc.event.llm.system
## @lineage: agent.atoa.disc.event.llm.system
## @lineage: atoa.agent.disc.event.llm.system
...
from eco.fiber.event.base import N_CHAR_PREVIEW, Event, LLMConvertibleEvent
