...
from atoa.disc.action.factory import MessageIntent, TopologicalIntent, CoreAction, ActionProxy, build_action
...
def _handle_bridge(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    ...
    from eco.gov.atoa.conv.command import TransitionStatus, UpdateAgentState
