# atoa.disc.action.tool.terminal
...
from atoa.disc.action.definition import DeclaredResources, ActionAnnotations, ActionDefinition
...
class TerminalTool(ActionDefinition[TerminalAction, TerminalObservation]):
    ...
    def create(
        ...
        from eco.gov.tool.terminal.executor import TerminalExecutor
