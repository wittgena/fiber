# atoa.disc.tool
## @lineage: atoa.gov.disc.tool
## @lineage: agent.atoa.disc.tool
## @lineage: eco.agent.disc.tool
## @lineage: eco.call.disc.tool
## @lineage: adapter.call.disc.tool
## @lineage: bound.adapter.call.disc.tool
## @lineage: agent.disc.schema.tool
