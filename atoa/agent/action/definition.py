# atoa.agent.action.definition
## @lineage: phi.agent.action.definition
## @lineage: swarm.phi.action.definition
## @lineage: agent.action.definition
## @lineage: gov.action.definition
