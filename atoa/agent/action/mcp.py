# atoa.agent.action.mcp
## @lineage: phi.agent.action.mcp
## @lineage: swarm.phi.action.mcp
## @lineage: agent.action.mcp
## @lineage: gov.action.mcp
## @lineage: atoa.disc.action.mcp
## @lineage: atoa.gov.disc.action.mcp
## @lineage: agent.atoa.action.mcp
import json
