# atoa.agent.mock.converter
## @lineage: atoa.call.mock.converter
## @lineage: agent.call.mock.converter
## @lineage: agent.llm.call.mock.converter
## @lineage: gov.llm.call.mock.converter
## @lineage: gov.llm.mock.converter
## @lineage: gov.sandbox.mock.converter
## @lineage: gov.llm.call.converter
import copy
import json
import re
from collections.abc import Iterable
from typing import Any, Literal, NotRequired, TypedDict, cast
from bound.gateway.switch.params import ChatCompletionToolParam, ChatCompletionToolParamFunctionChunk
from atoa.gov.exception.types import (
    FunctionCallConversionError,
    FunctionCallValidationError,
)
from atoa.agent.mock.icl import get_tool_icl
...
IN_CONTEXT_LEARNING_EXAMPLE_PREFIX = get_tool_icl
