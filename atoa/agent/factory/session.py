# atoa.agent.factory.session
## @lineage: agent.topos.factory.session
## @lineage: atoa.topos.factory.session
## @lineage: gov.sandbox.engine.factory.session
## @lineage: sandbox.factory.session
## @lineage: gov.sandbox.factory.session
## @lineage: gov.sandbox.tunnel.factory
## @lineage: gov.engine.tunnel.factory
## @lineage: gov.engine.executor.tunnel.factory
## @lineage: gov.executor.tunnel.factory
...
from atoa.agent.terminal.session import TerminalSession
...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from atoa.agent.terminal.tmux import (
                TmuxTerminal,
            )
            ...
            from atoa.agent.terminal.subprocess import (
                SubprocessTerminal,
            )
    ...
    if system == "Windows":
        ...
        if _is_tmux_available():
            ...
            from atoa.agent.terminal.subprocess import SubprocessTerminal
            _tmux_warning = (
