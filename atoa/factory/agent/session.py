# atoa.factory.agent.session
## @lineage: atoa.agent.factory.session
import platform
import subprocess
import warnings
...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from eco.gov.engine.tmux import (
                TmuxTerminal,
            )
            ...
            from eco.gov.engine.subprocess import (
                SubprocessTerminal,
            )
    ...
    if system == "Windows":
        ...
        if _is_tmux_available():
            ...
            from eco.gov.engine.subprocess import SubprocessTerminal
            _tmux_warning = (
