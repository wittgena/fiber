# gov.acp.build
## @lineage: gov.atoa.acp.build
## @lineage: eco.gov.atoa.acp.build
## @lineage: atoa.gov.acp.build
## @lineage: agent.gov.acp.build
## @lineage: gov.policy.acp.build
## @lineage: bound.bridge.transport.protocol.acp.client
from __future__ import annotations
from typing import Any
from acp.exceptions import RequestError
from acp.interfaces import Client
from acp.meta import CLIENT_METHODS
from gov.acp.router.message import MessageRouter
