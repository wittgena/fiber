# gov.acp.router.message
## @lineage: gov.atoa.acp.router.message
## @lineage: eco.gov.atoa.acp.router.message
## @lineage: atoa.gov.acp.router.message
## @lineage: agent.gov.acp.router.message
## @lineage: gov.policy.acp.router.message
## @lineage: bound.bridge.transport.protocol.acp.message
