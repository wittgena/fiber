# gov.factory.agent.session
## @lineage: atoa.factory.agent.session
...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from mesh.engine.subprocess import (
                SubprocessTerminal,
            )
    ...
    if system == "Windows":
        ...
        if _is_tmux_available():
            ...
            from mesh.engine.subprocess import SubprocessTerminal
            _tmux_warning = (
