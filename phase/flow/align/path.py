...
## @lineage: surgent.flow.align.path
import os
import sys
import argparse
import re
...
from xphi.state.runtime.executor.cli import execute_cli_task, CliTaskAdapter, dispatch_cli, parse_local
...
class PathAligner(PhaseAligner):
        ...
        for repo_dir in repo_dirs:
            ...
            for file_path in repo_dir.rglob("*"):
                ...
                try:
                    ...
                    ## [위상 검증] 주석 기호 뒤의 내용이 유효한 네임스페이스(공백 없는 영문/숫자/점/기호)인지 확인
                    ...
                    ## 중복 타이틀 검증 (바로 다음 줄이 완전히 동일한 형태의 네임스페이스인 경우에만 중복으로 판별)
