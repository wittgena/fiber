# actor.topos.scope.config
## @lineage: topos.scope.config
...
from actor.topos.scope.metadata import SettingsSchema
from actor.topos.scope.setting import VerificationSettings, export_settings_schema
