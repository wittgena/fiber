# fiber.llm.router.ext.types.base
## @lineage: fiber.dphi.model.ext.types.base
...
from fiber.llm.router.ext.llm.model.types.block import ChatMessage, MessageRole, TextBlock
from fiber.llm.router.mapper.pydantic import (
    BaseModel,
    GetCoreSchemaHandler,
    GetJsonSchemaHandler,
)
from fiber.llm.router.mapper.pydantic import CoreSchema, core_schema
