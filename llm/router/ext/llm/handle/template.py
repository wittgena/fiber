# fiber.llm.router.ext.llm.handle.template
## @lineage: fiber.dphi.model.ext.llm.handle.template
...
from fiber.llm.router.mapper.pydantic import BaseModel, ConfigDict
from fiber.llm.router.ext.llm.model.base import BaseLLM
from fiber.llm.router.util import get_template_vars, format_string
from fiber.llm.router.ext.types.base import BaseOutputParser
