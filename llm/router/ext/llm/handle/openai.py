# fiber.llm.router.ext.llm.handle.openai
...
import openai
from fiber.llm.router.ext.llm.handle.converter import get_from_param_or_env
...
from fiber.llm.router.mapper.pydantic import BaseModel
