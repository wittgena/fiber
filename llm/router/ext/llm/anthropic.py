# fiber.llm.router.ext.llm.anthropic
## @lineage: fiber.dphi.model.ext.llm.anthropic
...
from fiber.llm.router.ext.llm.model.types.block import TextBlock as LITextBlock
from fiber.llm.router.ext.llm.model.types.block import CitationBlock as LICitationBlock
from fiber.llm.router.ext.llm.model.types.block import ThinkingBlock as LIThinkingBlock
from fiber.llm.router.mapper.pydantic import Field, PrivateAttr
from fiber.llm.router.ext.callback.manager import CallbackManager
from fiber.llm.router.constants import DEFAULT_TEMPERATURE
from fiber.llm.router.ext.callback.manager import (
    llm_chat_callback,
    llm_completion_callback,
)
from fiber.llm.router.ext.llm.model.funcall import FunctionCallingLLM, ToolSelection
from fiber.llm.router.ext.types.base import BaseOutputParser, PydanticProgramMode, Model
from fiber.llm.router.ext.llm.handle.template import PromptTemplate
from fiber.llm.router.util import Tokenizer
from fiber.llm.router.ext.llm.handle.anthropic import (
