# fiber.llm.router.ext.llm.model.funcall
## @lineage: fiber.dphi.model.ext.llm.model.funcall
...
## @lineage: ator.client.ext.llm.model.funcall
## @lineage: bound.eco.agent.llm.model.funcall
## @lineage: eco.bound.agent.llm.model.funcall
## @lineage: bound.agent.llm.model.funcall
## @lineage: ext.router.llm.model.funcall
...
## @lineage: eco.llms.model.funcall
## @lineage: eco.llms.model.function_calling
import asyncio
...
class FunctionCallingLLM(LLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """Predict and call the tool."""
        from fiber.llm.router.ext.chat_engine.types import AgentChatResponse
        from fiber.llm.router.ext.tools.calling import (
