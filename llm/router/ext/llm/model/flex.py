# fiber.llm.router.ext.llm.model.flex
## @lineage: fiber.dphi.model.ext.llm.model.flex
## @lineage: dphi.model.ext.llm.model.flex
## @lineage: phase.client.model.llm.model.flex
## @lineage: phase.client.ext.llm.model.flex
## @lineage: bound.client.ext.llm.model.flex
## @lineage: ator.client.ext.llm.model.flex
## @lineage: bound.eco.agent.llm.model.flex
## @lineage: eco.bound.agent.llm.model.flex
## @lineage: bound.agent.llm.model.flex
...
from fiber.llm.router.ext.llm.model.llm import LLM, ToolSelection
from fiber.llm.router.ext.llm.handle.template import BasePromptTemplate
from fiber.llm.router.ext.llm.model.types.block import ChatResponse, CompletionResponse
...
from fiber.llm.router.ext.types.base import BasePydanticProgram, Model, PydanticProgramMode
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            from fiber.llm.router.util.prog.function_program import FunctionCallingProgram
            ...
            from fiber.llm.router.util.prog.llm_program import LLMTextCompletionProgram
