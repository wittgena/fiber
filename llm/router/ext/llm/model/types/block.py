# fiber.llm.router.ext.llm.model.types.block
## @lineage: fiber.dphi.model.ext.llm.model.types.block
## @lineage: dphi.model.ext.llm.model.types.block
## @lineage: phase.client.model.llm.model.types.block
## @lineage: phase.client.ext.llm.model.types.block
## @lineage: bound.client.ext.llm.model.types.block
## @lineage: ator.client.ext.llm.model.types.block
## @lineage: bound.eco.agent.llm.model.types.block
## @lineage: eco.bound.agent.llm.model.types.block
## @lineage: bound.agent.llm.model.types.block
## @lineage: ext.router.llm.model.types.block
...
from fiber.llm.router.constants import DEFAULT_CONTEXT_WINDOW, DEFAULT_NUM_OUTPUTS
from fiber.llm.router.ext.types.schema import ImageDocument
from fiber.llm.router.util import get_tokenizer, resolve_binary
...
class TextBlock(BaseContentBlock):
    ...
    async def asplit(
        ...
        from fiber.llm.router.ext.node_parser import TokenTextSplitter
