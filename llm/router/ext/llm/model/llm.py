# fiber.llm.router.ext.llm.model.llm
## @lineage: fiber.dphi.model.ext.llm.model.llm
## @lineage: dphi.model.ext.llm.model.llm
## @lineage: phase.client.model.llm.model.llm
## @lineage: phase.client.ext.llm.model.llm
## @lineage: bound.client.ext.llm.model.llm
## @lineage: ator.client.ext.llm.model.llm
## @lineage: bound.eco.agent.llm.model.llm
## @lineage: eco.bound.agent.llm.model.llm
## @lineage: bound.agent.llm.model.llm
## @lineage: ext.router.llm.model.llm
## @lineage: router.llm.model.llm
...
from fiber.llm.router.ext.llm.model.types.block import (
    ChatMessage,
...
from fiber.llm.router.mapper.pydantic import (
    BaseModel,
    WithJsonSchema,
    Field,
    field_validator,
...
from fiber.llm.router.ext.callback.event import CBEventType, EventPayload
from fiber.llm.router.ext.llm.model.base import BaseLLM
from fiber.llm.router.ext.llm.handle.template import default_messages_to_prompt as generic_messages_to_prompt
from fiber.llm.router.ext.llm.handle.template import BasePromptTemplate, PromptTemplate
from fiber.llm.router.ext.types.base import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from fiber.llm.router.ext.callback.event import (
    LLMPredictEndEvent,
...
from fiber.llm.router.ext.llm.model.types.block import ChatMessage

if TYPE_CHECKING:
    from fiber.llm.router.ext.chat_engine.types import AgentChatResponse
    from fiber.llm.router.ext.llm.model.flex import FlexibleModel
    from fiber.llm.router.ext.llm.model.types.tool import BaseTool
...
class LLM(BaseLLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        from fiber.llm.router.ext.agent.workflow import ReActAgent
        from fiber.llm.router.ext.agent.workflow.agent_context import SimpleAgentContext
        from fiber.llm.router.ext.chat_engine.types import AgentChatResponse
        from fiber.llm.router.ext.memory import Memory
        from fiber.llm.router.ext.tools import adapt_to_async_tool
        from fiber.llm.router.ext.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from fiber.llm.router.ext.memory import Memory
        from fiber.llm.router.ext.tools import adapt_to_async_tool
        from fiber.llm.router.ext.tools.calling import acall_tool_with_selection
