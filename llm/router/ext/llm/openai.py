# fiber.llm.router.ext.llm.openai
## @lineage: fiber.dphi.model.ext.llm.openai
...
from fiber.llm.router.ext.llm.handle.converter import (
...
from fiber.llm.router.ext.types.base import BaseOutputParser, PydanticProgramMode
from fiber.llm.router.ext.llm.handle.openai import (
    O1_MODELS,
