# fiber.llm.router.ext.embedding.base_sparse
## @lineage: fiber.dphi.model.ext.embedding.base_sparse
...
## @lineage: ator.client.ext.embedding.base_sparse
## @lineage: bound.eco.agent.embedding.base_sparse
## @lineage: eco.bound.agent.embedding.base_sparse
## @lineage: bound.agent.embedding.base_sparse
...
from fiber.llm.router.ext.callback.event import SparseEmbeddingEndEvent, SparseEmbeddingStartEvent
