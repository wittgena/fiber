# fiber.llm.router.ext.embedding.ollama
## @lineage: fiber.dphi.model.ext.embedding.ollama
...
## @lineage: ator.client.ext.embedding.ollama
## @lineage: bound.eco.agent.embedding.ollama
## @lineage: eco.bound.agent.embedding.ollama
## @lineage: bound.agent.embedding.ollama
## @lineage: ext.router.embedding.ollama
## @lineage: router.embedding.ollama
## @lineage: engine.router.embedding.ollama
from typing import Any, Dict, List, Optional, Union

from fiber.llm.router.ext.embedding.base import BaseEmbedding
