# fiber.llm.router.ext.embedding.base
## @lineage: fiber.dphi.model.ext.embedding.base
...
## @lineage: ator.client.ext.embedding.base
## @lineage: bound.eco.agent.embedding.base
## @lineage: eco.bound.agent.embedding.base
## @lineage: bound.agent.embedding.base
...
from fiber.llm.router.constants import DEFAULT_EMBED_BATCH_SIZE
from fiber.llm.router.ext.types.schema import BaseNode, MetadataMode, TransformComponent
from fiber.llm.router.util import get_tqdm_iterable
from fiber.llm.router.util import run_jobs

Embedding = List[float]

from fiber.llm.router.ext.callback.event import EmbeddingEndEvent, EmbeddingStartEvent
...
class BaseEmbedding(TransformComponent):
    ...
    def check_base_embeddings_class(self) -> Self:
        from fiber.llm.router.ext.storage.kvstore.types import BaseKVStore
