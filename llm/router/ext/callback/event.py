# fiber.llm.router.ext.callback.event
## @lineage: fiber.dphi.model.ext.callback.event
...
from fiber.llm.router.mapper.pydantic import BaseModel, SerializeAsAny, ConfigDict
