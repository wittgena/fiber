# fiber.llm.router.inter.registry
## @lineage: fiber.dphi.model.inter.registry
## @lineage: dphi.model.inter.registry
from typing import Dict

from fiber.llm.router.inter.adapter import BaseProviderAdapter, GenericHTTPAdapter
from fiber.llm.router.inter.llm import InterLLMAdapter
from fiber.llm.router.inter.embedding import InterEmbeddingAdapter
