# fiber.llm.router.llm.handle.openai
...
import openai
from fiber.llm.router.llm.handle.converter import get_from_param_or_env
...
from fiber.llm.mapper.pydantic import BaseModel
