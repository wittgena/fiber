# fiber.llm.router.llm.param.processor
...
from fiber.llm.constants import COMPLETION_HTTP_FALLBACK_SECONDS, DEFAULT_REQUEST_TIMEOUT_SECONDS, REQUEST_TIMEOUT, DEFAULT_CHAT_COMPLETION_PARAM_VALUES, DEFAULT_EMBEDDING_PARAM_VALUES
from fiber.llm.model.provider.resolver import _resolver_instance
from fiber.llm.types.provider.core import Usage
from fiber.llm.types.exception.eco import UnsupportedParamsError
...
class BaseProcessor:
    ...
    def _get_vendor_config_class(self) -> Optional[Any]:
        ...
        import fiber.llm.router.llm.param.vendor as VENDOR_PARAM_PKG
