# fiber.llm.types.llm.funcall
## @lineage: fiber.llm.router.llm.model.funcall
## @lineage: fiber.llm.router.ext.llm.model.funcall
...
class FunctionCallingLLM(LLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """Predict and call the tool."""
        from fiber.llm.router.chat_engine.types import AgentChatResponse
        from fiber.llm.router.tools.calling import (
