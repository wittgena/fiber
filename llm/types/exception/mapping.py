# fiber.llm.types.exception.mapping
## @lineage: fiber.llm.exception.mapping
...
from fiber.llm.types.exception.eco import (
    APIConnectionError,
    APIError,
    AuthenticationError,
    BadGatewayError,
...
from fiber.llm.types.exception.types import (
