# eco.tenant.action.param.format
import copy
import json
...
from bound.resolver.openai.types import AllMessageValues, ChatCompletionToolCallChunk
...
def map_developer_role_to_system_role(
    ...
    for m in messages:
        if m["role"] == "developer":
            log.debug("Translating developer role to system role for non-OpenAI providers.")
