# eco.tenant.action.embedding
## @lineage: eco.legacy.action.embedding
## @lineage: adapter.legacy.action.embedding
## @lineage: bound.surface.legacy.action.embedding
## @lineage: bound.adapter.surface.legacy.action.embedding
