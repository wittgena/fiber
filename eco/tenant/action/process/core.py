# eco.tenant.action.process.core
## @lineage: eco.legacy.action.process.core
## @lineage: adapter.legacy.action.process.core
## @lineage: bound.surface.legacy.action.process.core
## @lineage: bound.adapter.surface.legacy.action.process.core
## @lineage: bound.surface.client.action.process.core
## @lineage: bound.surface.action.process.core
## @lineage: bound.adapter.action.core
...
from eco.tenant.action.process.pre import CompletionPreprocessor
