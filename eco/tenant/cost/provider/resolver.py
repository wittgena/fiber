# eco.tenant.cost.provider.resolver
...
from bound.resolver.model.protype import ProviderTypesSet
...
class CostProvider:
    ...
    def resolve_selected_model(
        ...
        provider = CostProvider.resolve_provider(model=model, custom_llm_provider=custom_llm_provider)
        ...
        if (
            ...
            and not CostProvider._model_contains_known_llm_provider(return_model)
        ):
