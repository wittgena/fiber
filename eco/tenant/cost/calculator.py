# eco.tenant.cost.calculator
## @lineage: eco.legacy.cost.calculator
import time
...
from eco.tenant.cost.builtin import BuiltInToolCostTracker
...
from eco.tenant.cost.parser import (
...
def completion_cost(
    ...
    try:
        ...
        selected_model = CostProvider.resolve_selected_model(
            model=model,
        ...
        potential_model_names = [selected_model, CostProvider.resolve_response_model(completion_response)]
                ...
                if completion_response is not None and isinstance(completion_response, (BaseModel, dict)):
                    ...
                    if hidden_params is not None:
                        ...
                        if service_tier is None:
                            ...
                            if raw_traffic_type:
                                service_tier = CostProvider.map_traffic_to_tier(raw_traffic_type)
                else:
