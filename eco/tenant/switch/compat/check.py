# eco.tenant.switch.compat.check
## @lineage: eco.legacy.switch.compat.check
## @lineage: bound.gateway.switch.compat.check
## @lineage: bound.gateway.adapter.switch.compat.check
## @lineage: gateway.adapter.switch.compat.check
## @lineage: eco.switch.compat.check
## @lineage: adapter.switch.compat.check
## @lineage: bound.adapter.switch.compat.check
## @lineage: anchor.bind.switch.compat.check
## @lineage: bound.surface.switch.compat.check
