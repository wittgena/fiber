# eco.tenant.switch.compat.patch
## @lineage: eco.legacy.switch.compat.patch
## @lineage: bound.gateway.switch.compat.patch
## @lineage: bound.gateway.adapter.switch.compat.patch
