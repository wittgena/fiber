# eco.tenant.switch.chat.adapter
## @lineage: eco.legacy.switch.chat.adapter
## @lineage: bound.gateway.switch.chat.adapter
## @lineage: bound.gateway.adapter.switch.chat.adapter
## @lineage: gateway.adapter.switch.chat.adapter
## @lineage: eco.switch.chat.adapter
...
from eco.tenant.action.completion import acompletion
