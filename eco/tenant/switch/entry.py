# eco.tenant.switch.entry
## @lineage: eco.legacy.switch.entry
import os
from eco.tenant.switch.params import LITELLM_CONVERT_SWITCH
...
if not LITELLM_CONVERT_SWITCH:
    try:
        ...
        from eco.tenant.action.embedding import embedding, aembedding
        from eco.tenant.cost.calculator import completion_cost
