# eco.legacy.action.search
## @lineage: adapter.legacy.action.search
## @lineage: bound.surface.legacy.action.search
## @lineage: bound.adapter.surface.legacy.action.search
## @lineage: bound.surface.client.action.search
## @lineage: bound.surface.action.search
## @lineage: bound.bridge.channel.search.file
import json
import time
from typing import Any, Dict, Iterable, List, Optional, Tuple, Union, cast
from eco.legacy.action.response import aresponses
from eco.legacy.openai.types import ResponseOutputItem, ResponsesAPIResponse
from eco.legacy.param.embedding import VectorStoreSearchResult
