# eco.legacy.action.param.embedding
## @lineage: adapter.legacy.action.param.embedding
## @lineage: bound.surface.legacy.action.param.embedding
## @lineage: bound.adapter.surface.legacy.action.param.embedding
## @lineage: bound.surface.client.param.embedding
## @lineage: bound.surface.bridge.param.embedding
## @lineage: bound.surface.bridge.channel.param.embedding
## @lineage: bound.channel.param.embedding
## @lineage: bound.bridge.channel.param.embedding
from typing import (
    TYPE_CHECKING,
    Any,
    Callable,
...
from resolver.model.config.constants import (
...
from eco.legacy.action.param.optional import PreProcessNonDefaultParams, add_provider_specific_params_to_optional_params
