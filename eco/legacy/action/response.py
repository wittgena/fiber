# eco.legacy.action.response
## @lineage: adapter.legacy.action.response
## @lineage: bound.surface.legacy.action.response
## @lineage: bound.adapter.surface.legacy.action.response
...
class AsyncResponsesDispatcher:
    ...
    async def _dispatch_file_search(self) -> Optional[Any]:
        from eco.legacy.action.search import aresponses_with_emulated_file_search
