# eco.legacy.cost.parser
## @lineage: adapter.legacy.cost.parser
## @lineage: bound.surface.legacy.cost.parser
## @lineage: bound.adapter.surface.legacy.cost.parser
...
try:
    from eco.legacy.types import LiteLLMSendMessageResponse
except ImportError:
...
class UsageTelemetryParser:
    ...
    def combine_usage_objects(usage_objects: List[Usage]) -> Usage:
        from eco.legacy.types import CompletionTokensDetailsWrapper, PromptTokensDetailsWrapper
        combined = Usage()
