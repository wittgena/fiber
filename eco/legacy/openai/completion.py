# eco.legacy.openai.completion
## @lineage: adapter.legacy.openai.completion
## @lineage: bound.surface.legacy.openai.completion
## @lineage: bound.adapter.surface.legacy.openai.completion
...
from eco.legacy.openai.config import OpenAIConfig
