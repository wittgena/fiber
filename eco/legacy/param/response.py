# eco.legacy.param.response
## @lineage: adapter.legacy.param.response
## @lineage: bound.surface.legacy.param.response
## @lineage: bound.adapter.surface.legacy.param.response
from typing import List, Literal, Optional, Union
from openai.types.responses.response_function_tool_call import ResponseFunctionToolCall
from pydantic import PrivateAttr
from typing_extensions import Any, List, Optional, TypedDict
from eco.legacy.base import BaseOpenAIResponse
