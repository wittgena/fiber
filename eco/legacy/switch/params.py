# eco.legacy.switch.params
## @lineage: bound.gateway.switch.params
## @lineage: bound.gateway.adapter.switch.params
## @lineage: gateway.adapter.switch.params
## @lineage: eco.switch.params
## @lineage: adapter.switch.params
...
if not LITELLM_CONVERT_SWITCH:
    try:
        from eco.legacy.openai.types import ResponseAPIUsage, ResponsesAPIResponse
        from eco.legacy.openai.types import ResponsesAPIStreamingResponse
        from eco.legacy.openai.types import ToolParam
        from eco.legacy.openai.types import ChatCompletionToolParam
        from eco.legacy.openai.types import OutputFunctionToolCall
        from eco.legacy.openai.types import ResponseInputParam
        from eco.legacy.openai.types import ResponsesAPIResponse
        from eco.legacy.openai.types import ChatCompletionToolParamFunctionChunk
        from eco.legacy.openai.types import ResponsesAPIStreamEvents
        from eco.legacy.openai.types import OutputTextDeltaEvent, RefusalDeltaEvent, ReasoningSummaryTextDeltaEvent, ResponseCompletedEvent
        ## ---
        from eco.legacy.param.response import GenericResponseOutputItem
        from eco.legacy.param.rerank import RerankResponse
        from eco.legacy.param.completion import (
            ChatCompletionMessageParam,
            ChatCompletionSystemMessageParam,
            ChatCompletionUserMessageParam,
            ChatCompletionAssistantMessageParam,
        ...
        from eco.legacy.types import Usage
        from eco.legacy.types import TextChoices, TextCompletionResponse, TranscriptionResponse
        from eco.legacy.types import ModelResponse, ModelResponseStream, Delta, StreamingChoices, Choices, Message
        from eco.legacy.types import ChatCompletionMessageToolCall
