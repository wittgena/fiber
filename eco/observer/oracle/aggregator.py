# eco.observer.oracle.aggregator
...
from eco.observer.proof.binance import kline as binance_kline
from eco.observer.proof.coinbase import kline as coinbase_kline
