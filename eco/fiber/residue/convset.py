# eco.fiber.residue.convset
## @lineage: agent.eco.residue.convset
## @lineage: eco.agent.residue.convset
## @lineage: eco.call.residue.convset
## @lineage: adapter.call.residue.convset
## @lineage: bound.adapter.call.residue.convset
## @lineage: agent.context.conv.metadata
