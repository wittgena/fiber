# eco.fiber.residue.depre
## @lineage: agent.eco.residue.depre
## @lineage: eco.agent.residue.depre
## @lineage: eco.call.residue.depre
## @lineage: adapter.call.residue.depre
## @lineage: bound.adapter.call.residue.depre
## @lineage: agent.call.residue.depre
