# eco.fiber.secure.secret.validator
## @lineage: agent.eco.secure.secret.validator
## @lineage: bound.xor.secure.secret.validator
...
from bound.resolver.legacy.types import CredentialItem
