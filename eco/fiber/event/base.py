# eco.fiber.event.base
## @lineage: agent.eco.event.base
## @lineage: eco.agent.event.base
## @lineage: eco.call.event.base
## @lineage: adapter.call.event.base
## @lineage: bound.adapter.call.event.base
## @lineage: agent.disc.event.base
import __future__
import uuid
...
from eco.fiber.event.types import EventID, SourceType
from eco.fiber.action.message import ImageContent, Message, TextContent
