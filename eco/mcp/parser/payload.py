# eco.mcp.parser.payload
## @lineage: bound.mcp.parser.payload
## @lineage: bound.transport.mcp.parser.payload
## @lineage: bound.protocol.mcp.parser.payload
## @lineage: bound.bridge.transport.protocol.mcp.parser.payload
## @lineage: bound.bridge.protocol.mcp.parser.payload
...
from bound.gateway.switch.params import ResponsesAPIResponse, ModelResponse
from mcp_types import EmbeddedResource, ImageContent, TextContent
from eco.legacy.types import Choices
from eco.tenant.token.convert import convert_list_message_to_dict
