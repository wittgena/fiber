# eco.mcp.handler
## @lineage: bound.mcp.handler
## @lineage: bound.transport.mcp.handler
## @lineage: bound.protocol.mcp.handler
## @lineage: bound.bridge.transport.protocol.mcp.handler
## @lineage: bound.bridge.protocol.mcp.handler
"""
@phase: Adapter MCP
...
from eco.exception import BlockedPiiEntityError, GuardrailRaisedException
from eco.legacy.types import CallTypes, StandardLoggingMCPToolCall
from eco.mcp.tool.transform import transform_mcp_tool_to_openai_responses_api_tool, transform_mcp_tool_to_openai_tool
from eco.mcp.parser.payload import MCPPayloadParser
from eco.mcp.tool.manager import ToolCatalogManager
from eco.mcp.interface import MCPExecutionProtocol, MCPLoggerProtocol
...
class MCPHandler:
    ...
    def _convert_to_auth_context(user_api_key_auth: Any):
        from eco.proxy.reverse import BraneAuthContext
