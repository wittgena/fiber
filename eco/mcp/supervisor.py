# eco.mcp.supervisor
## @lineage: bound.mcp.supervisor
## @lineage: bound.transport.mcp.supervisor
## @lineage: bound.protocol.mcp.supervisor
## @lineage: bound.bridge.transport.protocol.mcp.supervisor
## @lineage: bound.bridge.protocol.mcp.supervisor
## @lineage: bound.transport.protocol.mcp.supervisor
## @lineage: bound.adapter.protocol.mcp.supervisor
## @lineage: bound.bridge.channel.task.supervisor
...
log = get_emitter("task.supervisor")
