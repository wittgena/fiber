...
from eco.gov.atoa.acp.client import ACPClient
from eco.gov.atoa.acp.step import ACPTrajectory
from eco.gov.atoa.acp.connection import ACPConnectionManifold

from arch.topos.bound.payload import StreamPayloadAdapter
from arch.topos.bound.tunnel import UniversalFacade

from eco.gov.atoa.acp.support import (
...
class ACPAgent(ACPTrajectory, Ator):
    ...
    async def initialize(self) -> None:
        ...
        with unified_flow_span(action="init_acp", workspace=os.getcwd()):
            ...
            from atoa.agent.executor.base import AsyncExecutor
