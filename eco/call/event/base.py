...
from eco.call.event.types import EventID, SourceType
from eco.call.action.message import ImageContent, Message, TextContent
...
class LLMConvertibleEvent(Event, ABC):
    ...
    def events_to_messages(events: list["LLMConvertibleEvent"]) -> list[Message]:
        ...
        from agent.disc.event.llm.action import ActionEvent
