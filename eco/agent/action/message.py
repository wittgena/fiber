...
from eco.tenant.switch.params import ChatCompletionMessageToolCall, ResponseFunctionToolCall, OutputFunctionToolCall
from eco.tenant.switch.params import GenericResponseOutputItem
