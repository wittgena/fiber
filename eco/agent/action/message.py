...
from eco.legacy.switch.params import ChatCompletionMessageToolCall, ResponseFunctionToolCall, OutputFunctionToolCall
from eco.legacy.switch.params import GenericResponseOutputItem
