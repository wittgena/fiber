...
from gateway.adapter.switch.params import ChatCompletionMessageToolCall, ResponseFunctionToolCall, OutputFunctionToolCall
from gateway.adapter.switch.params import GenericResponseOutputItem
