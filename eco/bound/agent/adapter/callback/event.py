# eco.bound.agent.adapter.callback.event
...
from eco.bound.agent.adapter.pydantic import BaseModel, SerializeAsAny, ConfigDict
from eco.bound.agent.llm.model.types.block import (
    ChatMessage,
    ChatResponse,
    CompletionResponse,
)
from eco.bound.agent.adapter.pydantic import ConfigDict, Field
