# eco.bound.agent.llm.model.flex
...
from eco.bound.agent.llm.model.llm import LLM, ToolSelection
from eco.bound.agent.llm.handle.template import BasePromptTemplate
from eco.bound.agent.llm.model.types.block import ChatResponse, CompletionResponse
...
from eco.bound.agent.adapter.types.base import BasePydanticProgram, Model, PydanticProgramMode
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            from eco.bound.agent.parser.prog.function_program import FunctionCallingProgram
            ...
            from eco.bound.agent.parser.prog.llm_program import LLMTextCompletionProgram
