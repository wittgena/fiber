...
from eco.bound.agent.adapter.parser import asyncio_run
...
from eco.bound.agent.adapter.callback.event import CBEventType, EventPayload
from eco.bound.agent.llm.model.base import BaseLLM
from eco.bound.agent.llm.handle.template import default_messages_to_prompt as generic_messages_to_prompt
from eco.bound.agent.llm.handle.template import BasePromptTemplate, PromptTemplate
from eco.bound.agent.adapter.types.base import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from eco.bound.agent.adapter.callback.event import (
    LLMPredictEndEvent,
...
from eco.bound.agent.adapter.callback.dispatcher import dispatcher
from eco.bound.agent.llm.model.types.block import ChatMessage

if TYPE_CHECKING:
    from eco.bound.agent.adapter.chat_engine.types import AgentChatResponse
    from eco.bound.agent.llm.model.flex import FlexibleModel
    from eco.bound.agent.llm.model.types.tool import BaseTool
...
class LLM(BaseLLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        from eco.bound.agent.adapter.agent.workflow import ReActAgent
        from eco.bound.agent.adapter.agent.workflow.agent_context import SimpleAgentContext
        from eco.bound.agent.adapter.chat_engine.types import AgentChatResponse
        from eco.bound.agent.adapter.memory import Memory
        from eco.bound.agent.adapter.tools import adapt_to_async_tool
        from eco.bound.agent.adapter.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from eco.bound.agent.adapter.memory import Memory
        from eco.bound.agent.adapter.tools import adapt_to_async_tool
        from eco.bound.agent.adapter.tools.calling import acall_tool_with_selection
