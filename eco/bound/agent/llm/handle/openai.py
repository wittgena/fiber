# eco.bound.agent.llm.handle.openai
...
import openai
from eco.bound.agent.llm.handle.converter import get_from_param_or_env
...
from eco.bound.agent.adapter.pydantic import BaseModel
