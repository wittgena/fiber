# eco.bound.agent.embedding.base
...
from eco.bound.agent.adapter.constants import DEFAULT_EMBED_BATCH_SIZE
from eco.bound.agent.adapter.types.schema import BaseNode, MetadataMode, TransformComponent
from eco.bound.agent.adapter.parser import get_tqdm_iterable
from eco.bound.agent.adapter.parser import run_jobs

Embedding = List[float]

from eco.bound.agent.adapter.callback.event import EmbeddingEndEvent, EmbeddingStartEvent
...
class BaseEmbedding(TransformComponent):
    ...
    def check_base_embeddings_class(self) -> Self:
        from eco.bound.agent.adapter.storage.kvstore.types import BaseKVStore
