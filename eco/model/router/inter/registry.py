# eco.model.router.inter.registry
## @lineage: engine.router.inter.registry
## @lineage: engine.client.inter.registry
from typing import Dict

from eco.model.router.base import BaseProviderAdapter, GenericHTTPAdapter
from eco.model.router.inter.llm import InterLLMAdapter
from eco.model.router.inter.embedding import InterEmbeddingAdapter
