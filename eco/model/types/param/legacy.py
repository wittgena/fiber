# eco.model.types.param.legacy
## @lineage: engine.model.types.param.legacy
## @lineage: bound.model.types.param.legacy
## @lineage: llm.types.param.legacy
## @lineage: eco.mesh.model.types.param.legacy
## @lineage: runtime.mesh.model.types.param.legacy
## @lineage: mesh.model.types.param.legacy
## @lineage: mesh.mapper.param.legacy
## @lineage: bound.mapper.param.legacy
import datetime
import enum
...
if TYPE_CHECKING:
    from engine.client.param.model import ModelResponse
...
class GenericParams(CredentialParams, PricingParams):
...
class LegacyParams(GenericParams):
    model: str
    model_config = ConfigDict(extra="allow", arbitrary_types_allowed=True)
