# eco.llama.inst.span_handlers.__init__
## @lineage: adapter.llama.inst.span_handlers.__init__
## @lineage: llama.inst.span_handlers.__init__
## @lineage: xor.loop.inst.span_handlers.__init__
