# eco.llama.inst.events.llm
## @lineage: adapter.llama.inst.events.llm
## @lineage: llama.inst.events.llm
## @lineage: xor.loop.inst.events.llm
## @lineage: xphi.loop.inst.events.llm
...
from eco.llama.anchor.bound.bridge.pydantic import BaseModel, SerializeAsAny, ConfigDict
...
from eco.llama.anchor.bound.prompts import BasePromptTemplate
