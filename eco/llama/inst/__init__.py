# eco.llama.inst.__init__
## @lineage: adapter.llama.inst.__init__
## @lineage: llama.inst.__init__
## @lineage: xor.loop.inst.__init__
## @lineage: xphi.loop.inst.__init__
...
from eco.llama.inst.dispatcher import (
    DISPATCHER_SPAN_DECORATED_ATTR,
    Dispatcher,
    Manager,
)
from eco.llama.inst.event_handlers import NullEventHandler
from eco.llama.inst.span_handlers import NullSpanHandler
