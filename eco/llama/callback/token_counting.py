# eco.llama.callback.token_counting
## @lineage: adapter.llama.callback.token_counting
...
from eco.llama.anchor.bound.utilities.token_counting import TokenCounter
from eco.llama.anchor.bound.utils import get_tokenizer
import logging

if TYPE_CHECKING:
    from eco.llama.flow.llm import ChatResponse, CompletionResponse
