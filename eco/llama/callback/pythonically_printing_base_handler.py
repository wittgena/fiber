# eco.llama.callback.pythonically_printing_base_handler
## @lineage: adapter.llama.callback.pythonically_printing_base_handler
## @lineage: llama.callback.pythonically_printing_base_handler
## @lineage: xor.loop.callback.pythonically_printing_base_handler
## @lineage: xphi.loop.callback.pythonically_printing_base_handler
