# eco.llama.callback.schema
## @lineage: adapter.llama.callback.schema
## @lineage: llama.callback.schema
## @lineage: xor.loop.callback.schema
## @lineage: xphi.loop.callback.schema
