# eco.llama.callback.global_handlers
## @lineage: adapter.llama.callback.global_handlers
## @lineage: llama.callback.global_handlers
## @lineage: xor.loop.callback.global_handlers
## @lineage: xphi.loop.callback.global_handlers
...
from eco.llama.callback.simple_llm_handler import SimpleLLMHandler


def set_global_handler(eval_mode: str, **eval_params: Any) -> None:
    """Set global eval handlers."""
    import eco.llama.anchor.bound
