# eco.llama.anchor.bound.base.embeddings.base
## @lineage: adapter.llama.anchor.bound.base.embeddings.base
...
from eco.llama.callback.base import CallbackManager
from eco.llama.callback.schema import CBEventType, EventPayload
from eco.llama.anchor.bound.constants import (
    DEFAULT_EMBED_BATCH_SIZE,
)
from eco.llama.inst import DispatcherSpanMixin
from eco.llama.anchor.bound.schema import BaseNode, MetadataMode, TransformComponent
from eco.llama.anchor.bound.utils import get_tqdm_iterable
from eco.llama.anchor.bound.async_utils import run_jobs

# TODO: change to numpy array
Embedding = List[float]


from eco.llama.inst.events.embedding import (
    EmbeddingEndEvent,
    EmbeddingStartEvent,
)
...
class BaseEmbedding(TransformComponent, DispatcherSpanMixin):
    ...
    def check_base_embeddings_class(self) -> Self:
        from eco.llama.anchor.bound.storage.kvstore.types import BaseKVStore
