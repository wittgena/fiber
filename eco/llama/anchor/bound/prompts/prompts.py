# eco.llama.anchor.bound.prompts.prompts
## @lineage: adapter.llama.anchor.bound.prompts.prompts
## @lineage: llama.anchor.bound.prompts.prompts
## @lineage: anchor.inter.bound.prompts.prompts
## @lineage: bound.adapter.llama.prompts.prompts
## @lineage: xphi.adapter.llama.prompts.prompts
"""Subclasses from base prompt."""

from eco.llama.anchor.bound.prompts.base import PromptTemplate
