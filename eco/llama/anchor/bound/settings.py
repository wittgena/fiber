...
from eco.tenant.token.splitter import TokenSplitter
from eco.tenant.token.window import ContextWindow
...
class _Settings:
    ...
    def context_window_engine(self) -> ContextWindow:
        ...
        if self._context_window is None:
            from eco.tenant.token.encoder import encode, decode
            safe_model = getattr(self.llm, "model", "gpt-3.5-turbo") if self._llm else "gpt-3.5-turbo"
