# eco.llama.anchor.embeddings.ollama.base
## @lineage: adapter.llama.anchor.embeddings.ollama.base
## @lineage: llama.anchor.embeddings.ollama.base
## @lineage: anchor.inter.embeddings.ollama.base
