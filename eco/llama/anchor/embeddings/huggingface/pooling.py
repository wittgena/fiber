# eco.llama.anchor.embeddings.huggingface.pooling
## @lineage: adapter.llama.anchor.embeddings.huggingface.pooling
## @lineage: llama.anchor.embeddings.huggingface.pooling
## @lineage: anchor.inter.embeddings.huggingface.pooling
