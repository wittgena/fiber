# eco.llama.anchor.embeddings.huggingface.base
## @lineage: adapter.llama.anchor.embeddings.huggingface.base
## @lineage: llama.anchor.embeddings.huggingface.base
## @lineage: anchor.inter.embeddings.huggingface.base
...
from eco.llama.anchor.bound.base.embeddings.base import (
...
from eco.llama.anchor.bound.utils import get_cache_dir, infer_torch_device
...
from eco.llama.anchor.bound.schema import ImageType
