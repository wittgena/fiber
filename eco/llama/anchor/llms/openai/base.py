# eco.llama.anchor.llms.openai.base
## @lineage: adapter.llama.anchor.llms.openai.base
...
from eco.llama.anchor.bound.constants import (
    DEFAULT_TEMPERATURE,
)
...
from eco.llama.anchor.bound.types import BaseOutputParser, PydanticProgramMode
from eco.llama.anchor.llms.openai.utils import (
    O1_MODELS,
...
class OpenAI(FunctionCallingLLM):
    ...
    def _structured_stream_call(
        ...
        **prompt_args: Any,
        ...
        if self._should_use_structure_outputs():
            from eco.llama.prog.streaming_utils import (
