# eco.llama.anchor.llms.google_genai.base
## @lineage: adapter.llama.anchor.llms.google_genai.base
...
from eco.llama.anchor.bound.bridge.pydantic import BaseModel, Field, PrivateAttr
from eco.llama.callback import CallbackManager
from eco.llama.anchor.bound.constants import DEFAULT_TEMPERATURE, DEFAULT_NUM_OUTPUTS
from eco.llama.flow.llm.callbacks import llm_chat_callback, llm_completion_callback
from eco.llama.flow.llm.function_calling import FunctionCallingLLM
from eco.llama.flow.llm.llm import ToolSelection, Model
from eco.llama.anchor.bound.prompts import PromptTemplate
from eco.llama.prog.utils import FlexibleModel, create_flexible_model
from eco.llama.anchor.bound.types import PydanticProgramMode
from eco.llama.anchor.llms.google_genai.utils import (
