# eco.llama.prog.utils
## @lineage: adapter.llama.prog.utils
...
from eco.llama.flow.llm.llm import LLM, ToolSelection
...
from eco.llama.anchor.bound.prompts.base import BasePromptTemplate
from eco.llama.anchor.bound.types import BasePydanticProgram, Model, PydanticProgramMode
from eco.llama.anchor.bound.base.llms.types import ChatResponse, CompletionResponse
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            from eco.llama.prog.function_program import FunctionCallingProgram
            ...
            from eco.llama.prog.llm_program import (
        ...
        from eco.llama.prog.llm_program import LLMTextCompletionProgram
