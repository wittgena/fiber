# eco.llama.flow.llm.utils
## @lineage: adapter.llama.flow.llm.utils
## @lineage: llama.flow.llm.utils
## @lineage: xor.loop.flow.llm.utils
## @lineage: xphi.loop.flow.llm.utils
...
from eco.llama.flow.llm.callbacks import CallbackManager
...
def resolve_llm(
    ...
    if llm == "default":
        ...
        if os.getenv("IS_TESTING"):
            from eco.llama.flow.llm.mock import MockLLM
