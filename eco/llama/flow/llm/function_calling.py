# eco.llama.flow.llm.function_calling
## @lineage: adapter.llama.flow.llm.function_calling
## @lineage: llama.flow.llm.function_calling
## @lineage: xor.loop.flow.llm.function_calling
## @lineage: xphi.loop.flow.llm.function_calling
...
class FunctionCallingLLM(LLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """Predict and call the tool."""
        from eco.llama.anchor.bound.chat_engine.types import AgentChatResponse
        from eco.llama.anchor.bound.tools.calling import (
