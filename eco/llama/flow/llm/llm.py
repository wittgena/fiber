# eco.llama.flow.llm.llm
## @lineage: adapter.llama.flow.llm.llm
...
from eco.llama.anchor.bound.async_utils import asyncio_run
from eco.llama.anchor.bound.base.llms.types import (
    ChatMessage,
...
from eco.llama.anchor.bound.bridge.pydantic import (
    BaseModel,
    WithJsonSchema,
    Field,
    field_validator,
...
from eco.llama.callback import CBEventType, EventPayload
from eco.llama.anchor.bound.base.llms.base import BaseLLM
from eco.llama.anchor.bound.base.llms.generic_utils import (
    messages_to_prompt as generic_messages_to_prompt,
)
from eco.llama.anchor.bound.prompts import BasePromptTemplate, PromptTemplate
from eco.llama.anchor.bound.types import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from eco.llama.inst.events.llm import (
    LLMPredictEndEvent,
...
import eco.llama.inst as instrument
from eco.llama.anchor.bound.base.llms.types import (
    ChatMessage,
)
...
if TYPE_CHECKING:
    from eco.llama.anchor.bound.chat_engine.types import AgentChatResponse
    from eco.llama.prog.utils import FlexibleModel
    from eco.llama.anchor.bound.tools.types import BaseTool
    from eco.llama.flow.llm.structured_llm import StructuredLLM
...
class LLM(BaseLLM):
    ...
    def structured_predict(
        ...
        **prompt_args: Any,
        ...
        """
        from eco.llama.prog.utils import get_program_for_llm
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """
        from eco.llama.anchor.bound.agent.workflow import ReActAgent
        from eco.llama.anchor.bound.agent.workflow.agent_context import SimpleAgentContext
        from eco.llama.anchor.bound.chat_engine.types import AgentChatResponse
        from eco.llama.anchor.bound.memory import Memory
        from eco.llama.anchor.bound.tools import adapt_to_async_tool
        from eco.llama.anchor.bound.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from eco.llama.anchor.bound.memory import Memory
        from eco.llama.anchor.bound.tools import adapt_to_async_tool
        from eco.llama.anchor.bound.tools.calling import acall_tool_with_selection
