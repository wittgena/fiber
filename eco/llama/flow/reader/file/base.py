# eco.llama.flow.reader.file.base
## @lineage: adapter.llama.flow.reader.file.base
## @lineage: llama.flow.reader.file.base
...
from eco.llama.anchor.bound.async_utils import get_asyncio_module, run_jobs
from eco.llama.anchor.bound.schema import Document
from eco.llama.anchor.bound.utils import get_tqdm_iterable

from eco.llama.flow.reader.base import BaseReader, ResourcesReaderMixin
...
def _try_loading_included_file_formats() -> dict[str, Type["BaseReader"]]:
    import importlib
    import eco.llama.flow.reader as reader_pkg
