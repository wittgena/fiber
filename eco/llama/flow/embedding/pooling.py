# eco.llama.flow.embedding.pooling
## @lineage: adapter.llama.flow.embedding.pooling
## @lineage: llama.flow.embedding.pooling
## @lineage: xor.loop.flow.embedding.pooling
## @lineage: xphi.loop.flow.embedding.pooling
