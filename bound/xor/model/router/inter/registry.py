# bound.xor.model.router.inter.registry
## @lineage: eco.model.router.inter.registry
## @lineage: engine.router.inter.registry
## @lineage: engine.client.inter.registry
from typing import Dict

from bound.xor.model.router.base import BaseProviderAdapter, GenericHTTPAdapter
from bound.xor.model.router.inter.llm import InterLLMAdapter
from bound.xor.model.router.inter.embedding import InterEmbeddingAdapter
