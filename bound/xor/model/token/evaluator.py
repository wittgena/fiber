# bound.xor.model.token.evaluator
## @lineage: bound.eco.agent.parser.token.evaluator
## @lineage: eco.bound.agent.parser.token.evaluator
...
from bound.xor.model.types.anthropic import AnthropicMessagesToolResultParam, AnthropicMessagesToolUseParam
from bound.xor.model.types.openai import (
    ChatCompletionNamedToolChoiceParam,
    AllMessageValues, 
    OpenAIMessageContent
)
from ator.client.model.param import ChatCompletionToolParam
from bound.xor.model.types.general import SelectTokenizerResponse
from arch.model.config import config
from bound.agent.constants import DEFAULT_IMAGE_TOKEN_COUNT
...
class TokenEvaluator:
    ...
    def _calculate_img_tokens_from_metadata(self, image_data: Any) -> int:
        ...
        from bound.xor.model.token.ext.vision import VisionMetadataExtractor
...
def token_counter(
    ...
    """
    from bound.xor.model.token.convert import convert_list_message_to_dict
    from bound.xor.model.token.encoder import encode # 정규화된 인코더 사용
