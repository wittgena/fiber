# bound.xor.opt.manifold.model.basetype
## @lineage: xor.opt.manifold.model.basetype
## @lineage: xphi.xor.opt.manifold.model.basetype
...
if TYPE_CHECKING:
    from bound.gateway.adapter.switch.params import ModelResponseStream
