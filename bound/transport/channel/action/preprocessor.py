# bound.transport.channel.action.preprocessor
...
from bound.surface.model.support import supports_httpx_timeout
...
from bound.bridge.channel.param.optional import get_optional_params
from bound.bridge.channel.param.litellm import get_litellm_params
from bound.bridge.channel.param.validator import (
...
class EmbeddingPreprocessor:
    ...
    def build(self) -> EmbeddingContext:
        ...
        from bound.bridge.channel.param.embedding import get_optional_params_embeddings
