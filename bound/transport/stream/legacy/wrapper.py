# bound.transport.stream.legacy.wrapper
...
import time
import traceback
from typing import Any, AsyncIterator, Callable, Dict, Iterator, List, NoReturn, Optional, Union, cast
import anyio
import httpx
...
from bound.transport.stream.support import (
...
class StreamWrapper:
    def __init__(
        ...
        self.logging_obj: LogDelegator = logging_obj
        ...
        if self.completion_stream is not None:
            ...
            with anyio.CancelScope(shield=True):
                try:
                    ...
                    log.debug("CustomStreamWrapper.aclose: error closing completion_stream: %s", e,)
                ...
                if original_chunk.choices and len(original_chunk.choices) > 0:
                    ...
                    if delta is not None and (
                        ...
                        try:
                            ...
                            log.exception("CustomStreamWrapper.chunk_creator(): Exception occured - {}".format(str(e)))
                            model_response.choices[0].delta = Delta()
