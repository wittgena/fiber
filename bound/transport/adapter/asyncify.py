# bound.transport.adapter.asyncify
## @lineage: bound.adapter.transport.asyncify
## @lineage: bound.transport.convert.asyncify
## @lineage: bound.surface.bridge.convert.asyncify
import asyncio
import functools
