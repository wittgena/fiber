# bound.transport.adapter.header
## @lineage: bound.adapter.transport.header
## @lineage: bound.transport.convert.header
## @lineage: bound.surface.bridge.convert.header
import httpx
from typing import Optional, Union
from adapter.legacy.types import OPENAI_RESPONSE_HEADERS
