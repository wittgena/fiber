# bound.eco.agent.adapter.callback.event
...
from bound.eco.agent.adapter.pydantic import BaseModel, SerializeAsAny, ConfigDict
from bound.eco.agent.llm.model.types.block import (
    ChatMessage,
    ChatResponse,
    CompletionResponse,
)
from bound.eco.agent.adapter.pydantic import ConfigDict, Field
