# bound.eco.agent.embedding.base
...
from bound.eco.agent.adapter.constants import DEFAULT_EMBED_BATCH_SIZE
from bound.eco.agent.adapter.types.schema import BaseNode, MetadataMode, TransformComponent
from bound.eco.agent.adapter.parser import get_tqdm_iterable
from bound.eco.agent.adapter.parser import run_jobs

Embedding = List[float]

from bound.eco.agent.adapter.callback.event import EmbeddingEndEvent, EmbeddingStartEvent
...
class BaseEmbedding(TransformComponent):
    ...
    def check_base_embeddings_class(self) -> Self:
        from bound.eco.agent.adapter.storage.kvstore.types import BaseKVStore
