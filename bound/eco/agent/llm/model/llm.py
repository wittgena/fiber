...
from bound.eco.agent.adapter.parser import asyncio_run
from bound.eco.agent.llm.model.types.block import (
    ChatMessage,
...
from bound.eco.agent.adapter.pydantic import (
    BaseModel,
    WithJsonSchema,
    Field,
    field_validator,
...
from bound.eco.agent.adapter.callback.event import CBEventType, EventPayload
from bound.eco.agent.llm.model.base import BaseLLM
from bound.eco.agent.llm.handle.template import default_messages_to_prompt as generic_messages_to_prompt
from bound.eco.agent.llm.handle.template import BasePromptTemplate, PromptTemplate
from bound.eco.agent.adapter.types.base import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from bound.eco.agent.adapter.callback.event import (
    LLMPredictEndEvent,
...
from bound.eco.agent.adapter.callback.dispatcher import dispatcher
from bound.eco.agent.llm.model.types.block import ChatMessage

if TYPE_CHECKING:
    from bound.eco.agent.adapter.chat_engine.types import AgentChatResponse
    from bound.eco.agent.llm.model.flex import FlexibleModel
    from bound.eco.agent.llm.model.types.tool import BaseTool
...
class LLM(BaseLLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        from bound.eco.agent.adapter.agent.workflow import ReActAgent
        from bound.eco.agent.adapter.agent.workflow.agent_context import SimpleAgentContext
        from bound.eco.agent.adapter.chat_engine.types import AgentChatResponse
        from bound.eco.agent.adapter.memory import Memory
        from bound.eco.agent.adapter.tools import adapt_to_async_tool
        from bound.eco.agent.adapter.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from bound.eco.agent.adapter.memory import Memory
        from bound.eco.agent.adapter.tools import adapt_to_async_tool
        from bound.eco.agent.adapter.tools.calling import acall_tool_with_selection
