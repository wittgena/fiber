# bound.eco.agent.llm.model.flex
...
from bound.eco.agent.llm.model.llm import LLM, ToolSelection
from bound.eco.agent.llm.handle.template import BasePromptTemplate
from bound.eco.agent.llm.model.types.block import ChatResponse, CompletionResponse
...
from bound.eco.agent.adapter.types.base import BasePydanticProgram, Model, PydanticProgramMode
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            from bound.eco.agent.parser.prog.function_program import FunctionCallingProgram
            ...
            from bound.eco.agent.parser.prog.llm_program import LLMTextCompletionProgram
