# bound.legacy.anthropic
## @lineage: eco.legacy.anthropic
## @lineage: adapter.legacy.anthropic
## @lineage: bound.surface.legacy.anthropic
## @lineage: bound.adapter.surface.legacy.anthropic
## @lineage: anchor.provider.legacy.anthropic
## @lineage: anchor.surface.model.client.anthropic
