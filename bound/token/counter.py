...
from bound.registry.model.config.constants import DEFAULT_IMAGE_TOKEN_COUNT
...
class TokenEvaluator:
    ...
    def _calculate_img_tokens_from_metadata(self, image_data: Any) -> int:
        ...
        from bound.token.ext.vision import VisionMetadataExtractor
...
def token_counter(
    ...
    from bound.token.encoder import encode # 정규화된 인코더 사용
