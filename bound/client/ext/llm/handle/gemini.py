# bound.client.ext.llm.handle.gemini
...
from bound.client.ext.llm.model.flex import _repair_incomplete_json
...
if TYPE_CHECKING:
    from bound.client.ext.llm.model.types.tool import BaseTool
