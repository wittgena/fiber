# bound.bridge.acp.sender
## @lineage: bound.bridge.transport.protocol.acp.conn.sender
## @lineage: bound.bridge.protocol.acp.conn.sender
## @lineage: bound.transport.protocol.acp.conn.sender
## @lineage: bound.adapter.protocol.acp.conn.sender
