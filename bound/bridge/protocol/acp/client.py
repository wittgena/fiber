# bound.bridge.protocol.acp.client
## @lineage: bound.transport.protocol.acp.client
## @lineage: bound.adapter.protocol.acp.client
## @lineage: bound.transport.acp.client
## @lineage: bound.transport.client
from __future__ import annotations
from typing import Any
from acp.exceptions import RequestError
from acp.interfaces import Client
from acp.meta import CLIENT_METHODS
from bound.bridge.protocol.acp.message import MessageRouter
...
from bound.bridge.protocol.acp.validator.model import normalize_result
