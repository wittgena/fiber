# bound.bridge.protocol.acp.message
## @lineage: bound.transport.protocol.acp.message
## @lineage: bound.adapter.protocol.acp.message
## @lineage: bound.transport.acp.message
## @lineage: bound.transport.message
...
from bound.bridge.protocol.acp.validator.model import to_camel_case
