# bound.bridge.channel.convert.request
...
from bound.bridge.channel.param.format import type_to_response_format_param
...
class RequestBuilder:
    ...
    def preprocess_requested_params(cls, params: Dict[str, Any]) -> ResponsesAPIOptionalRequestParams:
        ...
        from bound.bridge.channel.param.optional import PreProcessNonDefaultParams
