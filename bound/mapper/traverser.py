# bound.mapper.traverser
## @lineage: bound.gateway.adapter.mapper.traverser
## @lineage: gateway.adapter.mapper.traverser
## @lineage: eco.mapper.traverser
## @lineage: adapter.mapper.traverser
