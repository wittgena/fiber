# bound.mapper.param.embedding
## @lineage: eco.legacy.param.embedding
## @lineage: adapter.legacy.param.embedding
## @lineage: bound.surface.legacy.param.embedding
## @lineage: bound.adapter.surface.legacy.param.embedding
