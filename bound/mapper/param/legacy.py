# bound.mapper.param.legacy
## @lineage: eco.legacy.param.legacy
## @lineage: adapter.legacy.param.legacy
## @lineage: bound.surface.legacy.param.legacy
## @lineage: bound.adapter.surface.legacy.param.legacy
...
if TYPE_CHECKING:
    from bound.resolver.legacy.types import ModelResponse
