# bound.mapper.key
## @lineage: bound.gateway.adapter.mapper.key
## @lineage: gateway.adapter.mapper.key
## @lineage: eco.mapper.key
## @lineage: adapter.mapper.key
## @lineage: bound.adapter.mapper.key
