# bound.adapter.surface.legacy.openai.completion
## @lineage: bound.surface.legacy.openai.completion
## @lineage: anchor.provider.legacy.openai.completion
## @lineage: anchor.surface.model.client.openai.completion
...
from bound.adapter.surface.legacy.base import BaseLLM
from bound.adapter.surface.legacy.openai.base import (
    BaseOpenAILLM,
    OpenAIError,
    drop_params_from_unprocessable_entity_error,
)
from bound.adapter.surface.legacy.openai.config import OpenAIConfig
