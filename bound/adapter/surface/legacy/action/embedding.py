# bound.adapter.surface.legacy.action.embedding
## @lineage: bound.surface.legacy.action.embedding
## @lineage: bound.surface.client.action.embedding
## @lineage: bound.surface.action.embedding
...
from bound.adapter.surface.legacy.action.process.pre import EmbeddingPreprocessor
