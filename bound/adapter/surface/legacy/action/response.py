# bound.adapter.surface.legacy.action.response
## @lineage: bound.surface.legacy.action.response
## @lineage: bound.surface.client.action.response
## @lineage: bound.surface.action.response
import asyncio
import base64
import json
...
from bound.adapter.surface.legacy.param.response import *
...
from bound.adapter.surface.legacy.action.param.litellm import get_litellm_params, infer_openai_data_residency
...
class AsyncResponsesDispatcher:
    ...
    async def _dispatch_file_search(self) -> Optional[Any]:
        from bound.adapter.surface.legacy.action.search import aresponses_with_emulated_file_search
