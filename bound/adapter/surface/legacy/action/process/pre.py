# bound.adapter.surface.legacy.action.process.pre
...
from anchor.registry.model.config.constants import COMPLETION_HTTP_FALLBACK_SECONDS, DEFAULT_REQUEST_TIMEOUT_SECONDS
from bound.adapter.surface.legacy.types import EmbeddingResponse
from bound.adapter.switch.params import ModelResponse
from bound.adapter.surface.legacy.types import all_litellm_params
...
from bound.adapter.surface.legacy.openai.types import AllMessageValues
from bound.adapter.surface.legacy.action.param.optional import get_optional_params
from bound.adapter.surface.legacy.action.param.litellm import get_litellm_params
from bound.adapter.surface.legacy.action.param.validator import (
...
class EmbeddingPreprocessor:
    ...
    def build(self) -> EmbeddingContext:
        ...
        from bound.adapter.surface.legacy.action.param.embedding import get_optional_params_embeddings
