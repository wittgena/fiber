# bound.adapter.surface.legacy.action.search
...
from bound.adapter.surface.legacy.openai.types import ResponseOutputItem, ResponsesAPIResponse
from bound.adapter.surface.legacy.param.embedding import VectorStoreSearchResult
