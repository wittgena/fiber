# bound.adapter.surface.legacy.cost.parser
## @lineage: bound.surface.legacy.cost.parser
...
from bound.adapter.surface.legacy.param.rerank import RerankBilledUnits, RerankResponse
...
try:
    from bound.adapter.surface.legacy.types import LiteLLMSendMessageResponse
except ImportError:
...
class UsageTelemetryParser:
    ...
    def combine_usage_objects(usage_objects: List[Usage]) -> Usage:
        from bound.adapter.surface.legacy.types import CompletionTokensDetailsWrapper, PromptTokensDetailsWrapper
        combined = Usage()
