# bound.adapter.surface.legacy.cost.builtin
## @lineage: bound.surface.legacy.cost.builtin
## @lineage: bound.surface.cost.builtin
from typing import Any, Dict, List, Literal, Optional, Tuple

from bound.adapter.switch.params import Message, ModelResponse, Usage
from bound.adapter.surface.legacy.openai.types import FileSearchTool, ResponsesAPIResponse, WebSearchOptions
from bound.adapter.surface.legacy.types import ModelInfo, SearchContextCostPerQuery, StandardBuiltInToolsParams, PromptTokensDetailsWrapper

from anchor.registry.model.config.resolver import config
from anchor.registry.model.config.constants import OPENAI_FILE_SEARCH_COST_PER_1K_CALLS
...
class BuiltInToolCostTracker:
    ...
    def get_cost_for_file_search(
        ...
        if provider == "azure":
            from anchor.registry.model.config.constants import AZURE_FILE_SEARCH_COST_PER_GB_PER_DAY
    ...
    def get_cost_for_vector_store(
        ...
        if provider == "azure":
            from anchor.registry.model.config.constants import AZURE_VECTOR_STORE_COST_PER_GB_PER_DAY
