# bound.adapter.surface.token.counter
...
from bound.adapter.surface.legacy.anthropic import (
...
from bound.adapter.surface.legacy.types import SelectTokenizerResponse
from bound.adapter.switch.params import Message
from anchor.registry.model.config.resolver import config
from anchor.registry.model.config.constants import DEFAULT_IMAGE_TOKEN_COUNT
...
class TokenEvaluator:
    ...
    def _calculate_img_tokens_from_metadata(self, image_data: Any) -> int:
        ...
        from bound.adapter.surface.token.ext.vision import VisionMetadataExtractor
...
def token_counter(
    ...
    from bound.adapter.surface.token.encoder import encode # 정규화된 인코더 사용
