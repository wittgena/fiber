...
from bound.channel.param.optional import get_optional_params
from bound.channel.param.litellm import get_litellm_params
from bound.channel.param.validator import (
...
class EmbeddingPreprocessor:
    ...
    def build(self) -> EmbeddingContext:
        ...
        from bound.channel.param.embedding import get_optional_params_embeddings
