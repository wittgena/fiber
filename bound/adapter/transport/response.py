# bound.adapter.transport.response
## @lineage: bound.transport.convert.response
## @lineage: bound.surface.bridge.convert.response
## @lineage: bound.surface.bridge.channel.convert.response
## @lineage: bound.channel.convert.response
## @lineage: bound.bridge.channel.convert.response
## @lineage: bound.channel.bridge.convert.response
...
from bound.adapter.transport.header import get_response_headers
