# bound.adapter.transport.request
## @lineage: bound.transport.convert.request
## @lineage: bound.surface.bridge.convert.request
...
from bound.surface.client.param.format import type_to_response_format_param
...
class RequestBuilder:
    ...
    def preprocess_requested_params(cls, params: Dict[str, Any]) -> ResponsesAPIOptionalRequestParams:
        ...
        from bound.surface.client.param.optional import PreProcessNonDefaultParams
