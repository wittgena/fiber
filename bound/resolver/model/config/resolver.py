# bound.resolver.model.config.resolver
## @lineage: resolver.model.config.resolver
## @lineage: bound.registry.model.config.resolver
## @lineage: anchor.registry.model.config.resolver
