# bound.gateway.stream.bridge.response.stream.identity
## @lineage: gateway.stream.bridge.response.stream.identity
## @lineage: bound.bridge.response.stream.identity
## @lineage: bound.transport.bridge.response.stream.identity
## @lineage: bound.bridge.transport.response.stream.identity
