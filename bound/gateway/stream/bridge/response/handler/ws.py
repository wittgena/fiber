# bound.gateway.stream.bridge.response.handler.ws
## @lineage: gateway.stream.bridge.response.handler.ws
...
from bound.resolver.model.config.constants import REALTIME_WEBSOCKET_MAX_MESSAGE_SIZE_BYTES
