...
class TokenEvaluator:
    ...
    def _calculate_img_tokens_from_metadata(self, image_data: Any) -> int:
        ...
        from bound.gateway.token.ext.vision import VisionMetadataExtractor
...
def token_counter(
    ...
    from bound.gateway.token.encoder import encode # 정규화된 인코더 사용
