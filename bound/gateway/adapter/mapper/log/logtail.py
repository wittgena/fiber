# bound.gateway.adapter.mapper.log.logtail
## @lineage: gateway.adapter.mapper.log.logtail
## @lineage: eco.mapper.log.logtail
## @lineage: adapter.mapper.log.logtail
## @lineage: bound.adapter.mapper.log.logtail
"""
@problem.state:
