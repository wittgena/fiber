# bound.gateway.base
## @lineage: bound.gateway.bridge.base
## @lineage: bound.gateway.stream.bridge.base
## @lineage: gateway.stream.bridge.base
## @lineage: bound.bridge.base
## @lineage: bound.transport.bridge.base
## @lineage: bound.bridge.transport.base
## @lineage: bound.transport.handler.base
## @lineage: bound.transport.base
import ssl
...
log = get_emitter("transport.base")
