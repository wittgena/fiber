# bound.surface.response.identity
## @lineage: bound.surface.legacy.response.identity
## @lineage: bound.transport.response.identity
## @lineage: bound.transport.channel.response.identity
