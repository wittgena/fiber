# bound.surface.response.stream.iterator
...
from bound.surface.bridge.convert.header import process_response_headers
from bound.surface.bridge.api import get_api_base
from bound.surface.response.metadata import update_response_metadata
                    ...
                    if _event_type in (openai_types.ResponsesAPIStreamEvents.OUTPUT_ITEM_ADDED, openai_types.ResponsesAPIStreamEvents.OUTPUT_ITEM_DONE):
                        ...
                        if item:
                            ...
                            if encrypted_content and isinstance(encrypted_content, str) and _stream_model_id:
                                wrapped_content = ResponseIdentityManager._wrap_encrypted_content_with_model_id(encrypted_content, _stream_model_id)
