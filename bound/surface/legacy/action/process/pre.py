# bound.surface.legacy.action.process.pre
...
from bound.surface.legacy.action.param.litellm import get_litellm_params
from bound.surface.legacy.action.param.validator import (
...
class EmbeddingPreprocessor:
    ...
    def build(self) -> EmbeddingContext:
        ...
        from bound.surface.legacy.action.param.embedding import get_optional_params_embeddings
