...
from bound.surface.legacy.anthropic import (
...
class TokenEvaluator:
    ...
    def _calculate_img_tokens_from_metadata(self, image_data: Any) -> int:
        ...
        from bound.surface.token.ext.vision import VisionMetadataExtractor
...
def token_counter(
    ...
    from bound.surface.token.encoder import encode # 정규화된 인코더 사용
