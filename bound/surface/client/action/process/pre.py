# bound.surface.client.action.process.pre
...
from bound.surface.client.param.optional import get_optional_params
from bound.surface.client.param.litellm import get_litellm_params
from bound.surface.client.param.validator import (
...
class EmbeddingPreprocessor:
    ...
    def build(self) -> EmbeddingContext:
        ...
        from bound.surface.client.param.embedding import get_optional_params_embeddings
