# bound.surface.bridge.stream.mcp
## @lineage: bound.surface.bridge.channel.stream.mcp
## @lineage: bound.channel.stream.mcp
## @lineage: bound.transport.stream.mcp
## @lineage: bound.bridge.mcp.stream
## @lineage: bound.adapter.mcp.stream
from typing import TYPE_CHECKING, Any, Dict, List, Optional, Union, cast
from starlette.datastructures import Headers

from anchor.bind.switch.params import ResponsesAPIResponse, ResponsesAPIStreamingResponse
...
from bound.adapter.protocol.mcp.parser.header import MCPHeaderParser
from bound.adapter.protocol.mcp.parser.payload import MCPPayloadParser
from bound.adapter.protocol.mcp.event.call import create_mcp_call_events
