# bound.surface.bridge.api
## @lineage: bound.surface.bridge.channel.api
## @lineage: bound.channel.api
## @lineage: bound.bridge.channel.api
## @lineage: bound.channel.bridge.api
from typing import Any, Dict, Mapping, List, Optional, Type, Union, cast, get_type_hints, overload
from pydantic import BaseModel

from anchor.provider.param.legacy import LiteLLM_Params
...
from bound.surface.bridge.convert.request import RequestBuilder, IdentityMutator, _get_val
...
class APIBridge:
    ...
    def _decode_container_id(container_id: str) -> Dict[str, Any]:
        return ResponseIdentityManager._decode_container_id(container_id)

    @staticmethod
    def _decode_responses_api_response_id(response_id: str) -> str:
        return ResponseIdentityManager._decode_responses_api_response_id(response_id)
