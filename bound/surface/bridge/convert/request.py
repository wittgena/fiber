# bound.surface.bridge.convert.request
## @lineage: bound.surface.bridge.channel.convert.request
...
class RequestBuilder:
    ...
    def preprocess_requested_params(cls, params: Dict[str, Any]) -> ResponsesAPIOptionalRequestParams:
        ...
        from bound.surface.bridge.param.optional import PreProcessNonDefaultParams
