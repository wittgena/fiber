...
from bound.agent.adapter.parser import asyncio_run
...
from bound.agent.adapter.pydantic import (
    BaseModel,
    WithJsonSchema,
    Field,
    field_validator,
...
from bound.agent.adapter.callback.event import CBEventType, EventPayload
from bound.agent.llm.model.base import BaseLLM
from bound.agent.llm.handle.template import default_messages_to_prompt as generic_messages_to_prompt
from bound.agent.llm.handle.template import BasePromptTemplate, PromptTemplate
from bound.agent.adapter.types.base import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from bound.agent.adapter.callback.event import (
    LLMPredictEndEvent,
...
from bound.agent.llm.model.types.block import ChatMessage

if TYPE_CHECKING:
    from bound.agent.adapter.chat_engine.types import AgentChatResponse
    from bound.agent.llm.model.flex import FlexibleModel
...
class LLM(BaseLLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        from bound.agent.adapter.agent.workflow import ReActAgent
        from bound.agent.adapter.agent.workflow.agent_context import SimpleAgentContext
        from bound.agent.adapter.chat_engine.types import AgentChatResponse
        from bound.agent.adapter.memory import Memory
        from bound.agent.adapter.tools import adapt_to_async_tool
        from bound.agent.adapter.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from bound.agent.adapter.memory import Memory
        from bound.agent.adapter.tools import adapt_to_async_tool
        from bound.agent.adapter.tools.calling import acall_tool_with_selection
