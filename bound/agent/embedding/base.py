...
from bound.agent.adapter.constants import DEFAULT_EMBED_BATCH_SIZE
from bound.agent.adapter.types.schema import BaseNode, MetadataMode, TransformComponent
from bound.agent.adapter.parser import get_tqdm_iterable
from bound.agent.adapter.parser import run_jobs

Embedding = List[float]

from bound.agent.adapter.callback.event import EmbeddingEndEvent, EmbeddingStartEvent
...
class BaseEmbedding(TransformComponent):
    ...
    def check_base_embeddings_class(self) -> Self:
        from bound.agent.adapter.storage.kvstore.types import BaseKVStore
