# bound.agent.callback.event
## @lineage: bound.eco.agent.adapter.callback.event
## @lineage: eco.bound.agent.adapter.callback.event
## @lineage: bound.agent.adapter.callback.event
...
from bound.agent.pydantic import BaseModel, SerializeAsAny, ConfigDict
from ator.client.ext.llm.model.types.block import (
    ChatMessage,
    ChatResponse,
    CompletionResponse,
)
from bound.agent.pydantic import ConfigDict, Field
