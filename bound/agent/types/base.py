# bound.agent.types.base
## @lineage: bound.eco.agent.adapter.types.base
## @lineage: eco.bound.agent.adapter.types.base
## @lineage: bound.agent.adapter.types.base
...
## @lineage: eco.adapter.types.base
## @lineage: eco.runtime.types.base
## @lineage: eco.llama.types.base
## @lineage: runtime.bound.llama.types
## @lineage: eco.bound.types
## @lineage: eco.llama.bound.types
import threading
...
from ator.client.ext.llm.model.types.block import ChatMessage, MessageRole, TextBlock
from bound.agent.pydantic import (
    BaseModel,
    GetCoreSchemaHandler,
    GetJsonSchemaHandler,
)
from bound.agent.pydantic import CoreSchema, core_schema
