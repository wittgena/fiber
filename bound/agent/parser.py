# bound.agent.parser
## @lineage: bound.eco.agent.adapter.parser
## @lineage: eco.bound.agent.adapter.parser
## @lineage: bound.agent.adapter.parser
...
# ---------------------------------------------------------
if TYPE_CHECKING:
    from ator.client.ext.llm.model.types.block import ContentBlock, TextBlock
