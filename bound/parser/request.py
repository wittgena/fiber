# bound.parser.request
## @lineage: bound.gateway.parser.request
## @lineage: bound.gateway.request
...
class RequestBuilder:
    ...
    def preprocess_requested_params(cls, params: Dict[str, Any]) -> ResponsesAPIOptionalRequestParams:
        ...
        from eco.tenant.action.param.optional import PreProcessNonDefaultParams
