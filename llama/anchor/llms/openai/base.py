...
from llama.anchor.bound.constants import (
    DEFAULT_TEMPERATURE,
)
...
from llama.anchor.bound.types import BaseOutputParser, PydanticProgramMode
from llama.anchor.llms.openai.utils import (
    O1_MODELS,
...
class OpenAI(FunctionCallingLLM):
    ...
    def _structured_stream_call(
        ...
        **prompt_args: Any,
        ...
        if self._should_use_structure_outputs():
            from llama.prog.streaming_utils import (
