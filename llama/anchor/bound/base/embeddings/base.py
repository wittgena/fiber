# llama.anchor.bound.base.embeddings.base
...
from llama.callback.base import CallbackManager
from llama.callback.schema import CBEventType, EventPayload
from llama.anchor.bound.constants import (
    DEFAULT_EMBED_BATCH_SIZE,
)
from llama.inst import DispatcherSpanMixin
from llama.anchor.bound.schema import BaseNode, MetadataMode, TransformComponent
from llama.anchor.bound.utils import get_tqdm_iterable
from llama.anchor.bound.async_utils import run_jobs

# TODO: change to numpy array
Embedding = List[float]


from llama.inst.events.embedding import (
    EmbeddingEndEvent,
    EmbeddingStartEvent,
)
...
class BaseEmbedding(TransformComponent, DispatcherSpanMixin):
    ...
    def check_base_embeddings_class(self) -> Self:
        from llama.anchor.bound.storage.kvstore.types import BaseKVStore
