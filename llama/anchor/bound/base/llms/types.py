# llama.anchor.bound.base.llms.types
...
from llama.anchor.bound.constants import DEFAULT_CONTEXT_WINDOW, DEFAULT_NUM_OUTPUTS
from llama.anchor.bound.schema import ImageDocument
from llama.anchor.bound.utils import get_tokenizer, resolve_binary
...
class BaseContentBlock(ABC, BaseModel):
    ...
    def get_template_vars(self) -> list[str]:
        ...
        """
        from llama.anchor.bound.prompts.utils import get_template_vars
    ...
    def format_vars(self, **kwargs: Any) -> "BaseContentBlock":
        ...
        For that to work, the validation on those fields would need to be updated though.
        """
        from llama.anchor.bound.prompts.utils import format_string
...
class TextBlock(BaseContentBlock):
    ...
    async def asplit(
        ...
        from llama.anchor.bound.node_parser import TokenTextSplitter
