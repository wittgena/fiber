# llama.anchor.bound.prompts.utils
...
from llama.anchor.bound.base.llms.types import ContentBlock, TextBlock
from llama.anchor.bound.utils import resolve_binary
