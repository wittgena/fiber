# llama.anchor.bound.settings
## @lineage: anchor.inter.bound.settings
## @lineage: bound.adapter.llama.settings
from dataclasses import dataclass
from typing import Any, Callable, List, Optional

from bound.token.splitter import TokenSplitter
from bound.token.window import ContextWindow
from bound.token.counter import token_counter
from bound.registry.model.cost import model_cost

from llama.anchor.bound.prompts.utils import is_chat_model
from llama.anchor.bound.base.embeddings.base import BaseEmbedding
from llama.anchor.bound.schema import TransformComponent
from llama.anchor.bound.types import PydanticProgramMode

from llama.callback.base import BaseCallbackHandler, CallbackManager
from llama.flow.embedding.utils import EmbedType, resolve_embed_model
from llama.flow.llm.llm import LLM
from llama.flow.llm.utils import LLMType, resolve_llm
...
class _Settings:
    ...
    def context_window_engine(self) -> ContextWindow:
        ...
        if self._context_window is None:
            from bound.token.encoder import encode, decode
            safe_model = getattr(self.llm, "model", "gpt-3.5-turbo") if self._llm else "gpt-3.5-turbo"
