...
from llama.anchor.bound.async_utils import asyncio_run
from llama.anchor.bound.base.llms.types import (
    ChatMessage,
...
from llama.anchor.bound.bridge.pydantic import (
    BaseModel,
    WithJsonSchema,
    Field,
    field_validator,
...
from llama.callback import CBEventType, EventPayload
from llama.anchor.bound.base.llms.base import BaseLLM
from llama.anchor.bound.base.llms.generic_utils import (
    messages_to_prompt as generic_messages_to_prompt,
)
from llama.anchor.bound.prompts import BasePromptTemplate, PromptTemplate
from llama.anchor.bound.types import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from llama.inst.events.llm import (
    LLMPredictEndEvent,
...
import llama.inst as instrument
from llama.anchor.bound.base.llms.types import (
    ChatMessage,
)
...
if TYPE_CHECKING:
    from llama.anchor.bound.chat_engine.types import AgentChatResponse
    from llama.prog.utils import FlexibleModel
    from llama.anchor.bound.tools.types import BaseTool
    from llama.flow.llm.structured_llm import StructuredLLM
...
class LLM(BaseLLM):
    ...
    def structured_predict(
        ...
        **prompt_args: Any,
        ...
        """
        from llama.prog.utils import get_program_for_llm
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """
        from llama.anchor.bound.agent.workflow import ReActAgent
        from llama.anchor.bound.agent.workflow.agent_context import SimpleAgentContext
        from llama.anchor.bound.chat_engine.types import AgentChatResponse
        from llama.anchor.bound.memory import Memory
        from llama.anchor.bound.tools import adapt_to_async_tool
        from llama.anchor.bound.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from llama.anchor.bound.memory import Memory
        from llama.anchor.bound.tools import adapt_to_async_tool
        from llama.anchor.bound.tools.calling import acall_tool_with_selection
