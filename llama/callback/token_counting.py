...
from llama.callback.pythonically_printing_base_handler import PythonicallyPrintingBaseHandler
from llama.callback.schema import CBEventType, EventPayload
from llama.anchor.bound.utilities.token_counting import TokenCounter
from llama.anchor.bound.utils import get_tokenizer
import logging

if TYPE_CHECKING:
    from llama.flow.llm import ChatResponse, CompletionResponse
...
def get_llm_token_counts(
    ...
    from llama.flow.llm import ChatMessage
