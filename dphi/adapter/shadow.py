# fiber.dphi.adapter.shadow
## @lineage: fiber.infra.adapter.shadow
## @lineage: fiber.dphi.infra.shadow
## @lineage: fiber.dphi.eco.shadow
## @lineage: xphi.arch.eco.adapter.shadow
