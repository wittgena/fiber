# fiber.dphi.infra.observer.oracle.aggregator
## @lineage: fiber.dphi.observer.oracle.aggregator
...
from fiber.dphi.infra.observer.proof.binance import kline as binance_kline
from fiber.dphi.infra.observer.proof.coinbase import kline as coinbase_kline
