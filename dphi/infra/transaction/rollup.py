# fiber.dphi.infra.transaction.rollup
## @lineage: fiber.dphi.transaction.rollup
## @lineage: fiber.dphi.adapter.transaction.rollup
import os
import time
import hashlib
import json
...
class RollupAdapter:
    ...
    async def process_x402_settlement(self, invoice: Any) -> Any:
        from fiber.dphi.infra.transaction.settlement import X402SettlementReceipt
