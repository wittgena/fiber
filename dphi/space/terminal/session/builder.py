# dphi.space.terminal.session.builder
## @lineage: agent.space.terminal.session.builder
...
from fiber.runtime.tool.terminal import TerminalObservation
from fiber.runtime.terminal.context import (
    ExecutionContext,
    ExecutionEngine,
    ExecutionMiddleware,
)
...
if TYPE_CHECKING:
    ...
    from fiber.dphi.space.action.builder import DeclaredResources, ActionDefinition
...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from fiber.dphi.space.terminal.backend import SubprocessTerminal
