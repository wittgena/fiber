# fiber.dphi.model.ext.llm.model.types.block
...
from fiber.dphi.model.ext.types.schema import ImageDocument
from fiber.dphi.model.util import get_tokenizer, resolve_binary
...
class BaseContentBlock(ABC, BaseModel):
    ...
    def get_template_vars(self) -> list[str]:
        ...
        """
        from fiber.dphi.model.util import get_template_vars
    ...
    def format_vars(self, **kwargs: Any) -> "BaseContentBlock":
        ...
        For that to work, the validation on those fields would need to be updated though.
        """
        from fiber.dphi.model.util import format_string
...
class TextBlock(BaseContentBlock):
    ...
    async def asplit(
        ...
        from fiber.dphi.model.ext.node_parser import TokenTextSplitter
