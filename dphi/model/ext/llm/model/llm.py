# fiber.dphi.model.ext.llm.model.llm
...
from fiber.dphi.model.util import asyncio_run
...
from fiber.dphi.model.ext.types.base import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
if TYPE_CHECKING:
    from fiber.dphi.model.ext.chat_engine.types import AgentChatResponse
    from fiber.dphi.model.ext.llm.model.flex import FlexibleModel
...
class LLM(BaseLLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        from fiber.dphi.model.ext.agent.workflow import ReActAgent
        from fiber.dphi.model.ext.agent.workflow.agent_context import SimpleAgentContext
        from fiber.dphi.model.ext.chat_engine.types import AgentChatResponse
        from fiber.dphi.model.ext.memory import Memory
        from fiber.dphi.model.ext.tools import adapt_to_async_tool
        from fiber.dphi.model.ext.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from fiber.dphi.model.ext.memory import Memory
        from fiber.dphi.model.ext.tools import adapt_to_async_tool
        from fiber.dphi.model.ext.tools.calling import acall_tool_with_selection
