# fiber.dphi.model.ext.llm.model.flex
...
from fiber.dphi.model.ext.llm.model.llm import LLM, ToolSelection
from fiber.dphi.model.ext.llm.handle.template import BasePromptTemplate
from fiber.dphi.model.ext.llm.model.types.block import ChatResponse, CompletionResponse
...
from fiber.dphi.model.ext.types.base import BasePydanticProgram, Model, PydanticProgramMode
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            from fiber.dphi.model.util.prog.function_program import FunctionCallingProgram
            ...
            from fiber.dphi.model.util.prog.llm_program import LLMTextCompletionProgram
