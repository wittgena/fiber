...
from dphi.node.runner.sandbox import EpochBase
...
class EcoScene(SchemeRunner):
    ...
    async def _test_a2a_trustless_execution(self):
        ...
        await self._run_case("Eco: Execute Constrained Task (Fuel Tracked)", DphiMethod.EXECUTE_CODE.value, code_payload, expected_success=True)
