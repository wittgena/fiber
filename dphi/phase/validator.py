# dphi.phase.validator
## @lineage: epoch.time.exchange.net.validator
## @lineage: exchange.net.validator
...
from dphi.phase.config import mock_env, DphiEnv
...
if __name__ == "__main__":
    ...
    is_valid = asyncio.run(validator.execute())
    if not is_valid:
        exit(1)