# ator.action.resolver
## @lineage: engine.atoa.action.resolver
import json
...
from ator.action.factory import MessageIntent, TopologicalIntent, CoreAction, ActionProxy, build_action
...
def _handle_bridge(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    from ator.state.context.status import ConverStatus
    from ator.state.event.llm.observation import ObservationEvent
    from arch.contract.event.next import next_id
    from ator.state.command import TransitionStatus, UpdateAgentState
