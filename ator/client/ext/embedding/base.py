# ator.client.ext.embedding.base
...
from bound.agent.constants import DEFAULT_EMBED_BATCH_SIZE
from bound.agent.types.schema import BaseNode, MetadataMode, TransformComponent
from bound.agent.parser import get_tqdm_iterable
from bound.agent.parser import run_jobs

Embedding = List[float]

from bound.agent.callback.event import EmbeddingEndEvent, EmbeddingStartEvent
...
class BaseEmbedding(TransformComponent):
    ...
    def check_base_embeddings_class(self) -> Self:
        from bound.agent.storage.kvstore.types import BaseKVStore
