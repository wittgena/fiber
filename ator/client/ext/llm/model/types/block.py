# ator.client.ext.llm.model.types.block
...
from bound.agent.constants import DEFAULT_CONTEXT_WINDOW, DEFAULT_NUM_OUTPUTS
from bound.agent.types.schema import ImageDocument
from bound.agent.parser import get_tokenizer, resolve_binary
...
class BaseContentBlock(ABC, BaseModel):
    ...
    def get_template_vars(self) -> list[str]:
        ...
        """
        from bound.agent.parser import get_template_vars
    ...
    def format_vars(self, **kwargs: Any) -> "BaseContentBlock":
        ...
        For that to work, the validation on those fields would need to be updated though.
        """
        from bound.agent.parser import format_string
...
class TextBlock(BaseContentBlock):
    ...
    async def asplit(
        ...
        from bound.agent.node_parser import TokenTextSplitter
