# ator.client.ext.llm.model.flex
...
from ator.client.ext.llm.model.llm import LLM, ToolSelection
from ator.client.ext.llm.handle.template import BasePromptTemplate
from ator.client.ext.llm.model.types.block import ChatResponse, CompletionResponse
...
from bound.agent.types.base import BasePydanticProgram, Model, PydanticProgramMode
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            from bound.agent.parser.prog.function_program import FunctionCallingProgram
            ...
            from bound.agent.parser.prog.llm_program import LLMTextCompletionProgram
