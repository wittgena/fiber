...
from bound.agent.parser import asyncio_run
...
from bound.agent.pydantic import (
    BaseModel,
    WithJsonSchema,
    Field,
    field_validator,
...
from bound.agent.callback.event import CBEventType, EventPayload
from ator.client.ext.llm.model.base import BaseLLM
from ator.client.ext.llm.handle.template import default_messages_to_prompt as generic_messages_to_prompt
from ator.client.ext.llm.handle.template import BasePromptTemplate, PromptTemplate
from bound.agent.types.base import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from bound.agent.callback.event import (
    LLMPredictEndEvent,
...
from bound.agent.callback.dispatcher import dispatcher
from ator.client.ext.llm.model.types.block import ChatMessage

if TYPE_CHECKING:
    from bound.agent.chat_engine.types import AgentChatResponse
    from ator.client.ext.llm.model.flex import FlexibleModel
    from ator.client.ext.llm.model.types.tool import BaseTool
...
class LLM(BaseLLM):
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        from bound.agent.agent.workflow import ReActAgent
        from bound.agent.agent.workflow.agent_context import SimpleAgentContext
        from bound.agent.chat_engine.types import AgentChatResponse
        from bound.agent.memory import Memory
        from bound.agent.tools import adapt_to_async_tool
        from bound.agent.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from bound.agent.memory import Memory
        from bound.agent.tools import adapt_to_async_tool
        from bound.agent.tools.calling import acall_tool_with_selection
