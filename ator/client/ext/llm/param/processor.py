# ator.client.ext.llm.param.processor
...
from bound.agent.constants import COMPLETION_HTTP_FALLBACK_SECONDS, DEFAULT_REQUEST_TIMEOUT_SECONDS, REQUEST_TIMEOUT, DEFAULT_CHAT_COMPLETION_PARAM_VALUES, DEFAULT_EMBEDDING_PARAM_VALUES
from arch.model.config import config
from bound.xor.model.types.core import Usage
from bound.xor.model.info import get_features, supports_httpx_timeout, supports_function_calling, get_supported_openai_params
from ator.runtime.exception.eco import UnsupportedParamsError
from bound.xor.model.types.openai import ValidUserMessageContentTypes
...
class BaseProcessor:
    ...
    def _get_vendor_config_class(self) -> Optional[Any]:
        ...
        import ator.client.ext.llm.param.vendor as VENDOR_PARAM_PKG
