# ator.client.ext.llm.handle.gemini
...
from bound.agent.pydantic import BaseModel, ValidationError
...
from ator.client.ext.llm.model.flex import _repair_incomplete_json
