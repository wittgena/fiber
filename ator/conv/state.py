...
from ator.conv.event.llm.observation import (
    AgentErrorEvent,
    ObservationEvent,
...
from engine.xor.bridge.security.confirm import ConfirmationPolicyBase, NeverConfirm
...
from engine.xor.store.log import LogStore, VirtualEventLogProxy
    ...
    def __setattr__(self, name, value):
        ...
        if old is _sentinel or old != value:
            ...
            if callback is not None and old is not _sentinel:
                try:
                    from ator.conv.event.conv import ConversationStateUpdateEvent
