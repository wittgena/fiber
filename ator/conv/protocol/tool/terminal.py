# ator.conv.protocol.tool.terminal
import os
...
from bound.xor.bridge.tool.terminal import MAX_CMD_OUTPUT_SIZE, NO_CHANGE_TIMEOUT_SECONDS
...
class TerminalTool(ActionDefinition[TerminalAction, TerminalObservation]):
    ...
    def create(
        ...
        from ator.driver.tool.terminal.executor import TerminalExecutor
