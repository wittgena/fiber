# ator.context.visualizer
## @lineage: engine.atoa.context.visualizer
## @lineage: engine.protocol.atoa.context.visualizer
## @lineage: phi.agent.atoa.context.visualizer
## @lineage: agent.atoa.context.visualizer
## @lineage: agent.conver.conv.visualizer
## @lineage: phi.conver.conv.visualizer
## @lineage: swarm.conver.conv.visualizer
import logging
import re
...
from ator.state.event.acp import ACPToolCallEvent
from ator.state.event.conv import PauseEvent, ConversationStateUpdateEvent, ConversationErrorEvent
from ator.state.event.llm.action import ActionEvent
from ator.state.event.llm.message import MessageEvent
from ator.state.event.llm.observation import ObservationEvent, AgentErrorEvent, UserRejectObservation
