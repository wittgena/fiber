# ator.driver.tool.fedit.editor
## @lineage: driver.tool.fedit.editor
## @lineage: ator.bound.tool.fedit.editor
## @lineage: eco.tool.fedit.editor
## @lineage: engine.tool.fedit.editor
## @lineage: phi.tool.fedit.editor
## @lineage: phi.runtime.tool.fedit.editor
## @lineage: swarm.mesh.tool.fedit.editor
## @lineage: mesh.tool.fedit.editor
## @lineage: gov.tool.fedit.editor
## @lineage: eco.gov.tool.fedit.editor
## @lineage: atoa.gov.tool.fedit.editor
## @lineage: agent.gov.tool.fedit.editor
## @lineage: gov.sandbox.engine.tool.fedit.editor
## @lineage: agent.engine.tool.fedit.editor
## @lineage: sandbox.tool.fedit.editor
## @lineage: ops.xor.tool.fedit.editor
## @lineage: meta.xor.tool.fedit.editor
## @lineage: gov.engine.tool.fedit.editor
## @lineage: gov.engine.executor.tool.fedit.editor
import base64
import mimetypes
import os
import re
...
from ator.driver.tool.fedit.exceptions import (
    EditorToolParameterInvalidError,
    EditorToolParameterMissingError,
    FileValidationError,
    ToolError,
)
from ator.driver.tool.fedit.utils.config import SNIPPET_CONTEXT_WINDOW
...
from ator.driver.tool.fedit.utils.encoding import (
    EncodingManager,
    with_encoding,
)
from ator.driver.tool.fedit.utils.history import FileHistoryManager
from ator.driver.tool.fedit.utils.shell import run_shell_cmd
