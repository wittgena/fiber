# ator.driver.tool.builder.session
## @lineage: driver.builder.session
import platform
import subprocess
import warnings
...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from ator.driver.tool.terminal.backend import (
                SubprocessTerminal,
            )
    ...
    if system == "Windows":
        ...
        if _is_tmux_available():
            ...
            from ator.driver.tool.terminal.backend import SubprocessTerminal
            _tmux_warning = (
