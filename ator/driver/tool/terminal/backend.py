# ator.driver.tool.terminal.backend
## @lineage: driver.tool.terminal.backend
## @lineage: ator.bound.tool.terminal.backend
## @lineage: eco.tool.terminal.backend
## @lineage: engine.tool.terminal.backend
## @lineage: engine.terminal.backend
## @lineage: phi.executor.terminal.backend
## @lineage: phi.engine.terminal.backend
## @lineage: swarm.engine.terminal.backend
## @lineage: swarm.mesh.engine.terminal.backend
## @lineage: swarm.mesh.engine.subprocess
...
from bound.xor.bridge.tool.terminal import CmdOutputMetadata
