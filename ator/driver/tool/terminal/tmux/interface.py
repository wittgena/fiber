# ator.driver.tool.terminal.tmux.interface
## @lineage: driver.tool.terminal.tmux.interface
## @lineage: ator.bound.tool.terminal.tmux.interface
## @lineage: eco.tool.terminal.tmux.interface
## @lineage: engine.tool.terminal.tmux.interface
## @lineage: engine.terminal.tmux
import time
import uuid
import libtmux
