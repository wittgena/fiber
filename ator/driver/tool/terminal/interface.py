# ator.driver.tool.terminal.interface
## @lineage: driver.tool.terminal.interface
## @lineage: ator.bound.tool.terminal.interface
## @lineage: eco.tool.terminal.interface
## @lineage: engine.tool.terminal.interface
## @lineage: phi.tool.terminal.interface
## @lineage: phi.runtime.tool.terminal.interface
## @lineage: swarm.mesh.tool.terminal.interface
## @lineage: mesh.tool.terminal.interface
...
from engine.xor.bridge.tool.terminal import NO_CHANGE_TIMEOUT_SECONDS
