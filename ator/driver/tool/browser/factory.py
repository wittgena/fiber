# ator.driver.tool.browser.factory
## @lineage: driver.tool.browser.factory
## @lineage: ator.bound.tool.browser.factory
## @lineage: eco.tool.browser.factory
## @lineage: engine.tool.browser.factory
## @lineage: phi.tool.browser.factory
## @lineage: phi.runtime.tool.browser.factory
## @lineage: swarm.mesh.tool.browser.factory
## @lineage: mesh.tool.browser.factory
...
from ator.conv.protocol.observation.browser import BrowserAction, BrowserObservation

if sys.platform == "win32":
    from ator.driver.tool.browser.window import WindowsBrowserExecutor
else:
    from ator.driver.tool.browser.executor import BrowserExecutor
