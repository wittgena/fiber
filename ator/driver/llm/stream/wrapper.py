# ator.driver.llm.stream.wrapper
## @lineage: phase.llm.stream.wrapper
...
from bound.agent.constants import MAX_STREAMING_DURATION_SECONDS

from ator.runtime.exception.mapping import exception_type
from ator.runtime.exception.eco import OpenAIError
from ator.client.model.param import ModelResponseStream
from ator.driver.llm.stream.pipeline import (
    ChunkCodecHandler, 
    RuleGuardHandler, 
    StreamTelemetryHandler, 
    StreamYieldHandler
)
from ator.driver.llm.stream.accumulator import StreamAccumulator
from ator.driver.llm.stream.rule import Rules
...
class StreamWrapper:
    ...
    def _fire_fallback_error(self, e: Exception) -> NoReturn:
        from ator.runtime.exception.eco import MidStreamFallbackError
