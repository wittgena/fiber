# ator.driver.llm.event.observation
## @lineage: agent.space.conv.event.llm.observation
from typing import Literal
from pydantic import Field
from rich.text import Text
from arch.model.event import N_CHAR_PREVIEW, LLMConvertibleEvent
from arch.model.event import EventID, SourceType, ToolCallID
from ator.driver.schema.message import Message, TextContent, content_to_str
