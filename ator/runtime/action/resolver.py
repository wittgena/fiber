...
## @lineage: ator.agent.action.resolver
## @lineage: ator.action.resolver
import json
...
def _handle_bridge(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    from ator.conv.context.state.status import ConverStatus
    from ator.conv.event.llm.observation import ObservationEvent
    from arch.contract.event.next import next_id
    from ator.conv.command import TransitionStatus, UpdateAgentState
