...
from ator.runtime.action.factory import MessageIntent, TopologicalIntent, CoreAction, ActionProxy, build_action

if TYPE_CHECKING:
    from ator.driver.protocol.conv import ProtoConv
    from ator.driver.protocol.conv import ConvStateProtocol
...
def _handle_finish(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    ...
    from ator.runtime.conv.command import TransitionStatus
...
def _handle_bridge(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    from arch.topos.context.status import ConverStatus
    from ator.driver.llm.event.observation import ObservationEvent
    from arch.contract.event.next import next_id
    from ator.runtime.conv.command import TransitionStatus, UpdateAgentState
