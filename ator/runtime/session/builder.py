...
from ator.driver.llm.event.observation import AgentErrorEvent
from ator.driver.protocol.tool.terminal import TerminalObservation
from ator.driver.protocol.terminal.context import (
    ExecutionContext,
    ExecutionEngine,
    ExecutionMiddleware,
)
...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from ator.runtime.terminal.backend import SubprocessTerminal
