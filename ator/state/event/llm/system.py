# ator.state.event.llm.system
## @lineage: engine.atoa.event.llm.system
## @lineage: engine.protocol.atoa.event.llm.system
## @lineage: phi.agent.atoa.event.llm.system
## @lineage: agent.atoa.event.llm.system
## @lineage: atoa.event.llm.system
## @lineage: swarm.atoa.event.llm.system
...
from engine.parser.conv.event import N_CHAR_PREVIEW, Event, LLMConvertibleEvent
