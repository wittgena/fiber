# ator.state.event.llm.observation
## @lineage: engine.atoa.event.llm.observation
## @lineage: engine.protocol.atoa.event.llm.observation
## @lineage: phi.agent.atoa.event.llm.observation
## @lineage: agent.atoa.event.llm.observation
## @lineage: atoa.event.llm.observation
## @lineage: swarm.atoa.event.llm.observation
## @lineage: atoa.disc.event.llm.observation
## @lineage: atoa.gov.disc.event.llm.observation
## @lineage: agent.atoa.disc.event.llm.observation
## @lineage: atoa.agent.disc.event.llm.observation
from typing import Literal
from pydantic import Field
from rich.text import Text
from engine.parser.conv.event import N_CHAR_PREVIEW, LLMConvertibleEvent
from engine.parser.conv.event import EventID, SourceType, ToolCallID
from engine.parser.conv.message import Message, TextContent, content_to_str
