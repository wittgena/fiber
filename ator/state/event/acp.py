# ator.state.event.acp
## @lineage: engine.atoa.event.acp
## @lineage: engine.protocol.atoa.event.acp
## @lineage: phi.agent.atoa.event.acp
## @lineage: agent.atoa.event.acp
## @lineage: atoa.event.acp
## @lineage: swarm.atoa.event.acp
## @lineage: atoa.disc.event.acp
## @lineage: atoa.gov.disc.event.acp
## @lineage: agent.atoa.disc.event.acp
## @lineage: atoa.agent.disc.event.acp
