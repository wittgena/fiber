# ator.state.event.conv
## @lineage: engine.atoa.event.conv
## @lineage: engine.protocol.atoa.event.conv
## @lineage: phi.agent.atoa.event.conv
## @lineage: agent.atoa.event.conv
## @lineage: atoa.event.conv
## @lineage: swarm.atoa.event.conv
import uuid
from typing import Any
from pydantic import Field
from rich.text import Text
from engine.parser.conv.event import Event, SourceType
