...
from adapter.llama.anchor.bound.bridge.pydantic import BaseModel, SerializeAsAny, ConfigDict
...
from adapter.llama.anchor.bound.prompts import BasePromptTemplate
