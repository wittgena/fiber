# adapter.llama.prog.utils
## @lineage: llama.prog.utils
## @lineage: xor.loop.prog.utils
## @lineage: xphi.loop.prog.utils
...
from adapter.llama.flow.llm.llm import LLM, ToolSelection
...
from adapter.llama.anchor.bound.prompts.base import BasePromptTemplate
from adapter.llama.anchor.bound.types import BasePydanticProgram, Model, PydanticProgramMode
from adapter.llama.anchor.bound.base.llms.types import ChatResponse, CompletionResponse
    ...
    **kwargs: Any,
    ...
    if pydantic_program_mode == PydanticProgramMode.DEFAULT:
        if llm.metadata.is_function_calling_model:
            from adapter.llama.prog.function_program import FunctionCallingProgram
            ...
            from adapter.llama.prog.llm_program import (
        ...
        from adapter.llama.prog.llm_program import LLMTextCompletionProgram
