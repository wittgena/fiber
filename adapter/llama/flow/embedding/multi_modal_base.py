# adapter.llama.flow.embedding.multi_modal_base
## @lineage: llama.flow.embedding.multi_modal_base
## @lineage: xor.loop.flow.embedding.multi_modal_base
## @lineage: xphi.loop.flow.embedding.multi_modal_base
