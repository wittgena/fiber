# adapter.llama.flow.reader.base
...
from adapter.llama.anchor.bound.bridge.pydantic import ConfigDict, Field
from adapter.llama.anchor.bound.schema import BaseComponent, Document
