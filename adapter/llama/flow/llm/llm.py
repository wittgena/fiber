# adapter.llama.flow.llm.llm
## @lineage: llama.flow.llm.llm
## @lineage: xor.loop.flow.llm.llm
## @lineage: xphi.loop.flow.llm.llm
...
from adapter.llama.anchor.bound.async_utils import asyncio_run
from adapter.llama.anchor.bound.base.llms.types import (
    ChatMessage,
...
from adapter.llama.anchor.bound.bridge.pydantic import (
    BaseModel,
    WithJsonSchema,
    Field,
    field_validator,
...
from adapter.llama.callback import CBEventType, EventPayload
from adapter.llama.anchor.bound.base.llms.base import BaseLLM
from adapter.llama.anchor.bound.base.llms.generic_utils import (
    messages_to_prompt as generic_messages_to_prompt,
)
from adapter.llama.anchor.bound.prompts import BasePromptTemplate, PromptTemplate
from adapter.llama.anchor.bound.types import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
from adapter.llama.inst.events.llm import (
    LLMPredictEndEvent,
...
import adapter.llama.inst as instrument
from adapter.llama.anchor.bound.base.llms.types import (
    ChatMessage,
)
...
if TYPE_CHECKING:
    from adapter.llama.anchor.bound.chat_engine.types import AgentChatResponse
    from adapter.llama.prog.utils import FlexibleModel
    from adapter.llama.anchor.bound.tools.types import BaseTool
    from adapter.llama.flow.llm.structured_llm import StructuredLLM
...
class LLM(BaseLLM):
    ...
    def structured_predict(
        ...
        **prompt_args: Any,
        ...
        """
        from adapter.llama.prog.utils import get_program_for_llm
    ...
    def predict_and_call(
        ...
        **kwargs: Any,
        ...
        """
        from adapter.llama.anchor.bound.agent.workflow import ReActAgent
        from adapter.llama.anchor.bound.agent.workflow.agent_context import SimpleAgentContext
        from adapter.llama.anchor.bound.chat_engine.types import AgentChatResponse
        from adapter.llama.anchor.bound.memory import Memory
        from adapter.llama.anchor.bound.tools import adapt_to_async_tool
        from adapter.llama.anchor.bound.tools.calling import call_tool_with_selection
    ...
    async def apredict_and_call(
        ...
        **kwargs: Any,
        ...
        from adapter.llama.anchor.bound.memory import Memory
        from adapter.llama.anchor.bound.tools import adapt_to_async_tool
        from adapter.llama.anchor.bound.tools.calling import acall_tool_with_selection
