# adapter.llama.flow.llm.structured_llm
## @lineage: llama.flow.llm.structured_llm
## @lineage: xor.loop.flow.llm.structured_llm
## @lineage: xphi.loop.flow.llm.structured_llm
...
from adapter.llama.anchor.bound.base.llms.types import ChatMessage, MessageRole
...
from adapter.llama.anchor.bound.base.llms.types import LLMMetadata
from adapter.llama.flow.llm.callbacks import (
    llm_chat_callback,
    llm_completion_callback,
)
from adapter.llama.anchor.bound.prompts.base import ChatPromptTemplate
