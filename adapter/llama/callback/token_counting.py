# adapter.llama.callback.token_counting
## @lineage: llama.callback.token_counting
## @lineage: xor.loop.callback.token_counting
## @lineage: xphi.loop.callback.token_counting
...
from adapter.llama.callback.pythonically_printing_base_handler import PythonicallyPrintingBaseHandler
from adapter.llama.callback.schema import CBEventType, EventPayload
from adapter.llama.anchor.bound.utilities.token_counting import TokenCounter
from adapter.llama.anchor.bound.utils import get_tokenizer
import logging

if TYPE_CHECKING:
    from adapter.llama.flow.llm import ChatResponse, CompletionResponse
...
def get_llm_token_counts(
    ...
    from adapter.llama.flow.llm import ChatMessage
