# adapter.llama.anchor.bound.output_parsers.pydantic
...
from adapter.llama.anchor.bound.output_parsers import BaseOutputParser
from adapter.llama.anchor.bound.output_parsers.utils import extract_json_str
