# adapter.llama.anchor.bound.output_parsers.selection
...
from adapter.llama.anchor.bound.output_parsers.base import (
    OutputParserException,
    StructuredOutput,
)
from adapter.llama.anchor.bound.output_parsers.utils import _marshal_llm_to_json
