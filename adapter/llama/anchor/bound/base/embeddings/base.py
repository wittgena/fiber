# adapter.llama.anchor.bound.base.embeddings.base
## @lineage: llama.anchor.bound.base.embeddings.base
## @lineage: anchor.inter.bound.base.embeddings.base
...
from adapter.llama.callback.base import CallbackManager
from adapter.llama.callback.schema import CBEventType, EventPayload
from adapter.llama.anchor.bound.constants import (
    DEFAULT_EMBED_BATCH_SIZE,
)
from adapter.llama.inst import DispatcherSpanMixin
from adapter.llama.anchor.bound.schema import BaseNode, MetadataMode, TransformComponent
from adapter.llama.anchor.bound.utils import get_tqdm_iterable
from adapter.llama.anchor.bound.async_utils import run_jobs

# TODO: change to numpy array
Embedding = List[float]


from adapter.llama.inst.events.embedding import (
    EmbeddingEndEvent,
    EmbeddingStartEvent,
)
...
class BaseEmbedding(TransformComponent, DispatcherSpanMixin):
    ...
    def check_base_embeddings_class(self) -> Self:
        from adapter.llama.anchor.bound.storage.kvstore.types import BaseKVStore
