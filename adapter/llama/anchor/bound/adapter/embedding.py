# adapter.llama.anchor.bound.adapter.embedding
## @lineage: llama.anchor.bound.adapter.embedding
## @lineage: anchor.inter.bound.adapter.embedding
## @lineage: bound.adapter.inter.embedding
...
from adapter.legacy.action.process.pre import EmbeddingContext
from adapter.llama.anchor.bound.adapter.base import BaseProviderAdapter
