# adapter.llama.anchor.bound.prompts.utils
...
from adapter.llama.anchor.bound.base.llms.types import ContentBlock, TextBlock
from adapter.llama.anchor.bound.utils import resolve_binary
