# adapter.llama.anchor.llms.google_genai.base
## @lineage: llama.anchor.llms.google_genai.base
## @lineage: anchor.inter.llms.google_genai.base
import asyncio
import inspect
import functools
import os
...
from adapter.llama.anchor.bound.bridge.pydantic import BaseModel, Field, PrivateAttr
from adapter.llama.callback import CallbackManager
from adapter.llama.anchor.bound.constants import DEFAULT_TEMPERATURE, DEFAULT_NUM_OUTPUTS
from adapter.llama.flow.llm.callbacks import llm_chat_callback, llm_completion_callback
from adapter.llama.flow.llm.function_calling import FunctionCallingLLM
from adapter.llama.flow.llm.llm import ToolSelection, Model
from adapter.llama.anchor.bound.prompts import PromptTemplate
from adapter.llama.prog.utils import FlexibleModel, create_flexible_model
from adapter.llama.anchor.bound.types import PydanticProgramMode
from adapter.llama.anchor.llms.google_genai.utils import (
