# adapter.llama.anchor.llms.openai_like.base
...
from adapter.llama.anchor.bound.bridge.pydantic import Field
from adapter.llama.anchor.bound.constants import DEFAULT_CONTEXT_WINDOW
