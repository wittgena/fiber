# adapter.llama.anchor.llms.anthropic.base
## @lineage: llama.anchor.llms.anthropic.base
## @lineage: anchor.inter.llms.anthropic.base
...
from adapter.llama.flow.llm.utils import parse_partial_json
...
from adapter.llama.anchor.bound.base.llms.types import TextBlock as LITextBlock
from adapter.llama.anchor.bound.base.llms.types import CitationBlock as LICitationBlock
from adapter.llama.anchor.bound.base.llms.types import ThinkingBlock as LIThinkingBlock
from adapter.llama.anchor.bound.bridge.pydantic import Field, PrivateAttr
from adapter.llama.callback import CallbackManager
from adapter.llama.anchor.bound.constants import DEFAULT_TEMPERATURE
from adapter.llama.flow.llm.callbacks import (
    llm_chat_callback,
    llm_completion_callback,
)
from adapter.llama.flow.llm.function_calling import FunctionCallingLLM, ToolSelection
from adapter.llama.anchor.bound.types import BaseOutputParser, PydanticProgramMode, Model
from adapter.llama.anchor.bound.prompts import PromptTemplate
from adapter.llama.anchor.bound.utils import Tokenizer
from adapter.llama.anchor.llms.anthropic.utils import (
