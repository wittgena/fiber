# adapter.llama.anchor.llms.openai.base
## @lineage: llama.anchor.llms.openai.base
## @lineage: anchor.inter.llms.openai.base
...
from adapter.llama.anchor.bound.constants import (
    DEFAULT_TEMPERATURE,
)
...
from adapter.llama.anchor.bound.types import BaseOutputParser, PydanticProgramMode
from adapter.llama.anchor.llms.openai.utils import (
    O1_MODELS,
...
class OpenAI(FunctionCallingLLM):
    ...
    def _structured_stream_call(
        ...
        **prompt_args: Any,
        ...
        if self._should_use_structure_outputs():
            from adapter.llama.prog.streaming_utils import (
