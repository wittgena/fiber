# adapter.llama.anchor.readers.file.image.base
...
from adapter.llama.anchor.bound.schema import Document, ImageDocument
from adapter.llama.anchor.bound.utils import infer_torch_device
...
class ImageReader(BaseReader):
    ...
    def load_data(
        ...
        """Parse file."""
        from adapter.llama.anchor.bound.img_utils import img_2_b64
