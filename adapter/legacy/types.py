# adapter.legacy.types
## @lineage: bound.surface.legacy.types
## @lineage: bound.adapter.surface.legacy.types
import json
import time
...
from adapter.legacy.base import BaseOpenAIResponse, PydanticObjectBase
from adapter.mapper.reason import map_finish_reason
from adapter.legacy.base import HiddenParams
...
from adapter.legacy.info import ProviderSpecificModelInfo

if TYPE_CHECKING:
    from adapter.legacy.param.embedding import VectorStoreSearchResponse
else:
    VectorStoreSearchResponse = Any

from adapter.legacy.info import ProviderTypes
from adapter.legacy.param.legacy import CustomPricingLiteLLMParams
