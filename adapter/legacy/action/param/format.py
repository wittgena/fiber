# adapter.legacy.action.param.format
## @lineage: bound.surface.legacy.action.param.format
## @lineage: bound.adapter.surface.legacy.action.param.format
import copy
import json
...
from adapter.legacy.openai.types import AllMessageValues, ChatCompletionToolCallChunk
from adapter.legacy.base import PydanticObjectBase
from adapter.legacy.info import ProviderSpecificModelInfo
from adapter.switch.params import Message

from watcher.plane.emitter import get_emitter

log = get_emitter("param.format")
