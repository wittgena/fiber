...
try:
    from adapter.legacy.types import LiteLLMSendMessageResponse
except ImportError:
...
class UsageTelemetryParser:
    ...
    def combine_usage_objects(usage_objects: List[Usage]) -> Usage:
        from adapter.legacy.types import CompletionTokensDetailsWrapper, PromptTokensDetailsWrapper
        combined = Usage()
