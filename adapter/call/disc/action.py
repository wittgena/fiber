# adapter.call.disc.action
## @lineage: bound.adapter.call.disc.action
from abc import ABC
...
from adapter.call.action.message import ImageContent, TextContent
from adapter.call.action.message import content_to_str
