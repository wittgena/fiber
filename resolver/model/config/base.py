# resolver.model.config.base
## @lineage: bound.resolver.model.config.base
...
from resolver.model.config.constants import DEFAULT_MAX_TOKENS, RESPONSE_FORMAT_TOOL_NAME
