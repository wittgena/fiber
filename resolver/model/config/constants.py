# resolver.model.config.constants
## @lineage: bound.resolver.model.config.constants
## @lineage: bound.registry.model.config.constants
## @lineage: anchor.registry.model.config.constants
## @lineage: bound.surface.legacy.config.constants
import os
import sys
