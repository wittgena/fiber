# topos.xelog.edge.a2a.compute
## @lineage: topos.ops.xelog.edge.a2a.compute
## @lineage: ops.xelog.edge.a2a.compute
from fastapi import APIRouter, Depends, HTTPException, status
import json
import time

from topos.xelog.depend import get_wasm_broker
...
compute_edge = APIRouter(prefix="/a2a/v1", tags=["A2A (Trustless Compute)"])
