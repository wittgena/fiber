# topos.ops.scope.execution.graph
...
from topos.ops.scope.execution.compiler import BlueprintCompiler
from topos.ops.scope.execution.strategy import LocalExecutionStrategy, ProxyExecutionStrategy
