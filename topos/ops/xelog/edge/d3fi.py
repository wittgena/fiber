# topos.ops.xelog.edge.d3fi
## @lineage: ops.xelog.edge.d3fi
import json
import time
from fastapi import APIRouter, Depends, HTTPException, status
from topos.ops.xelog.depend import get_wasm_broker, get_exchange_adapter
from topos.ops.xelog.topos.ingress.policy import IngressPolicyEngine, get_ingress_policy
from topos.ops.xelog.topos.state.edge import (
    EdgeState,
    TradeIngressRequest,
