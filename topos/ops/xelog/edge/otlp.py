...
from topos.ops.xelog.depend import get_wasm_broker, get_pubsub
from topos.ops.xelog.topos.tenant import TenantEco, get_tenant_eco
from topos.ops.xelog.topos.state.edge import EdgeState, EdgeHeader
...
async def otlp_logs_export(
    ...
    try:
        ## 원본 해싱 - Python Edge 단에서 수행하여 WASM 부하 최소화
        ...
        ## WASM Kernel: 경량화된 영수증 봉인 (Fat Payload 분리)
        kernel_payload = {
