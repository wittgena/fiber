# topos.gateway.ingress.transducer
## @lineage: void.topos.gateway.ingress.transducer
## @lineage: topos.edge.gateway.ingress.transducer
## @lineage: edge.gateway.ingress.transducer
## @lineage: fiber.gateway.ingress.transducer
"""
@desc: 
...
from watcher.kernel.bridge.schema import (
    LogicStream,
    StreamMetadata,
    StreamIdentity,
    LogicPayload,
