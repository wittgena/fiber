...
class BlueprintCompiler:
    """Compiles execution graphs into LLM-readable instructions."""
...
# ==========================================
# 3. Execution Engines (Local & Proxy)
# ==========================================
...
class LocalExecutionEngine:
    """Orchestrates the local agent lifecycle, tools, and execution loop."""
