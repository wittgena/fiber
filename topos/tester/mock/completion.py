# topos.tester.mock.completion
## @lineage: void.topos.tester.mock.completion
## @lineage: topos.audit.tester.mock.completion
## @lineage: gov.audit.tester.mock.completion
## @lineage: audit.tester.mock.completion
## @lineage: ops.tester.mock.completion
## @lineage: xor.scope.mock.completion
...
from eco.tenant.switch.params import ModelResponse, Choices, Message
...
def create_mock_tool_call(
    ...
    """
    import json
    from eco.tenant.switch.params import ChatCompletionMessageToolCall, Function
