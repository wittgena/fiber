# agent.gov.tool.browser.factory
...
from agent.atoa.action.tool.schema.browser import BrowserAction, BrowserObservation

if sys.platform == "win32":
    from agent.gov.tool.browser.window import WindowsBrowserExecutor
else:
    from agent.gov.tool.browser.executor import BrowserExecutor
