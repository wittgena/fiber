...
from agent.action.definition import DeclaredResources, ActionAnnotations, ActionDefinition
...
class TerminalTool(ActionDefinition[TerminalAction, TerminalObservation]):
    ...
    def create(
        ...
        from swarm.mesh.tool.terminal.executor import TerminalExecutor
