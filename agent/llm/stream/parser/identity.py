...
## @lineage: inter.parser.stream.identity
## @lineage: runtime.parser.stream.identity
## @lineage: runtime.stream.parser.identity
## @lineage: mesh.stream.parser.identity
## @lineage: bound.gateway.parser.stream.identity
import base64
import re
import os
from typing import Any, Dict, Iterable, Optional, Type
from starlette.datastructures import Headers
from fiber.agent.llm.param import DecodedResponseId
