...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from agent.topos.terminal.tmux import (
                TmuxTerminal,
            )
            ...
            from agent.topos.terminal.subprocess import (
                SubprocessTerminal,
            )
    ...
    if system == "Windows":
        ...
        if _is_tmux_available():
            ...
            from agent.topos.terminal.subprocess import SubprocessTerminal
            _tmux_warning = (
