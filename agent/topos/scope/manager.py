# agent.topos.scope.manager
## @lineage: phase.agent.topos.scope.manager
## @lineage: agent.nexus.topos.scope.manager
## @lineage: nexus.agent.topos.scope.manager
## @lineage: meta.agent.topos.scope.manager
## @lineage: topos.scope.manager
## @lineage: meta.agent.flow
import asyncio
import json
from typing import Dict, Any, Optional
from contextlib import asynccontextmanager, AsyncExitStack

from fiber.agent.executor import LoopExecutor

from fiber.agent.topos.node.runtime import RuntimeNode
from fiber.agent.topos.scope.observer import ManifoldFolder, FlowTransition
from fiber.agent.topos.scope.surface import get_surface_class, SurfaceConfig

from fiber.dphi.space.manager import SpaceNode, space_provider
