# agent.topos.bound.folding
## @lineage: phase.agent.topos.bound.folding
## @lineage: agent.nexus.topos.bound.folding
## @lineage: nexus.agent.topos.bound.folding
## @lineage: meta.agent.topos.bound.folding
## @lineage: topos.bound.folding
## @lineage: kernel.bind.folding
import contextlib
import types
import inspect
import functools
...
from fiber.agent.topos.bound.transcript.spec import TranscriptSpec
