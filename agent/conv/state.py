...
from fiber.runtime.action.types import ConversationCallbackType, ConversationID, ConversationTags
from fiber.runtime.event.action import ActionEvent
from fiber.runtime.event.observation import (
    AgentErrorEvent,
    ObservationEvent,
    UserRejectObservation,
)
from fiber.runtime.command.conv import (
    StateCommand, 
    TransitionStatus, 
    BlockAction, 
    BlockMessage, 
    ...
    def __setattr__(self, name, value):
        ...
        if old is _sentinel or old != value:
            ...
            if callback is not None and old is not _sentinel:
                try:
                    from fiber.runtime.event.conv import ConversationStateUpdateEvent
