# agent.conv.visual.context
## @lineage: agent.loop.conv.visual.context
## @lineage: agent.context.conv.visual.context
import logging
import re
...
from fiber.runtime.event.acp import ACPToolCallEvent
from fiber.runtime.event.conv import PauseEvent, ConversationStateUpdateEvent, ConversationErrorEvent
from fiber.runtime.event.action import ActionEvent
from fiber.runtime.event.message import MessageEvent
from fiber.runtime.event.observation import ObservationEvent, AgentErrorEvent, UserRejectObservation
from fiber.runtime.event.system import SystemPromptEvent
