...
## @lineage: agent.space.context.adapter
...
from fiber.runtime.event.message import MessageEvent
from fiber.runtime.event.observation import UserRejectObservation
from fiber.runtime.action.types import ConversationID
from fiber.llm.driver.model import LLMModel
from fiber.dphi.space.action.message import Message, TextContent
from fiber.runtime.command.stats import ConversationStats
from fiber.runtime.security.analyzer import SecurityAnalyzerBase
from xphi.arch.model.conv.security.confirm import ConfirmationPolicyBase, NeverConfirm

from fiber.runtime.context import AgentCommunicationProtocol, ExecutionControlProtocol, SecurityControlProtocol
from fiber.runtime.command.protocol import ProtoConv, EngineContextProtocol
from fiber.runtime.command.protocol import ConvStateProtocol
from fiber.runtime.command.conv import TransitionStatus, UpdateSecurityPolicy
from fiber.agent.context.actor import Actor
from fiber.llm.driver.facade import MessageBuilder, LLMFacade
...
class SecurityManager:
    ...
    def reject_pending_actions(self, reason: str = "User rejected the action") -> None:
        from fiber.agent.conv.state import ConversationState
        state = self._context.state
