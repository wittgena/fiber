# fiber.agent.engine.tool.action.resolver
## @lineage: fiber.agent.client.tool.action.resolver
## @lineage: surgent.topos.protocol.action.resolver
## @lineage: surgent.agent.protocol.action.resolver
## @lineage: surgent.space.runtime.action.resolver
import json
...
from fiber.agent.engine.tool.action.factory import MessageIntent, TopologicalIntent, CoreAction, ActionProxy, build_action
...
def _handle_finish(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    ...
    from fiber.agent.conver.protocol.command import TransitionStatus
...
def _handle_bridge(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    from fiber.agent.conver.status import ConverStatus
    from fiber.agent.engine.event.observation import ObservationEvent
    from xphi.arch.event.next import next_id
    from fiber.agent.conver.protocol.command import TransitionStatus, UpdateAgentState
