# fiber.agent.engine.tool.action.types
## @lineage: fiber.agent.client.tool.action.types
## @lineage: surgent.topos.protocol.action.types
## @lineage: surgent.agent.protocol.action.types
## @lineage: surgent.space.runtime.action.types
## @lineage: space.runtime.action.types
## @lineage: runtime.action.types
## @lineage: agent.space.action.types
import re
import uuid
