# fiber.agent.engine.tool.schema.action
## @lineage: fiber.agent.client.tool.schema.action
## @lineage: surgent.conv.schema.action
## @lineage: conv.schema.action
## @lineage: space.schema.action
## @lineage: dphi.space.action.action
## @lineage: agent.space.action.action
## @lineage: bound.space.action.action
...
from fiber.llm.model.message import content_to_str
