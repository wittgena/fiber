# fiber.agent.engine.tool.schema.terminal
## @lineage: fiber.agent.client.tool.schema.terminal
...
from fiber.agent.engine.tool.schema.builder import DeclaredResources, ActionAnnotations, ActionDefinition
