# fiber.agent.engine.tool.schema.mcp
## @lineage: fiber.agent.client.tool.schema.mcp
## @lineage: surgent.conv.schema.mcp
## @lineage: conv.schema.mcp
## @lineage: space.schema.mcp
## @lineage: dphi.space.action.mcp
## @lineage: agent.space.action.mcp
## @lineage: bound.space.action.mcp
