# fiber.agent.engine.protocol.builder
## @lineage: fiber.infra.protocol.builder
...
from fiber.agent.engine.tool.schema.terminal import TerminalObservation
from fiber.agent.engine.tool.terminal.context import (
    ExecutionContext,
    ExecutionEngine,
    ExecutionMiddleware,
)
...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from fiber.agent.engine.tool.terminal.backend import SubprocessTerminal
