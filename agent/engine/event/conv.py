# fiber.agent.engine.event.conv
## @lineage: fiber.agent.client.event.conv
## @lineage: surgent.conv.event.conv
## @lineage: conv.event.conv
## @lineage: space.event.conv
## @lineage: runtime.event.conv
## @lineage: agent.llm.driver.event.conv
## @lineage: ator.driver.llm.event.conv
## @lineage: agent.context.conv.event.conv
import uuid
from typing import Any
from pydantic import Field
from rich.text import Text
from xphi.arch.model.conv.event import Event, SourceType
