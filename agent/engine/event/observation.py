# fiber.agent.engine.event.observation
## @lineage: fiber.agent.client.event.observation
## @lineage: surgent.conv.event.observation
## @lineage: conv.event.observation
## @lineage: space.event.observation
## @lineage: runtime.event.observation
## @lineage: agent.llm.driver.event.observation
## @lineage: ator.driver.llm.event.observation
## @lineage: agent.space.conv.event.llm.observation
...
from fiber.llm.model.message import Message, TextContent, content_to_str
