# fiber.agent.engine.event.system
## @lineage: fiber.agent.client.event.system
## @lineage: surgent.conv.event.system
## @lineage: conv.event.system
## @lineage: space.event.system
## @lineage: runtime.event.system
## @lineage: agent.llm.driver.event.system
## @lineage: ator.driver.llm.event.system
import __future__
import json
from pydantic import Field, model_validator
from rich.text import Text
from typing import TYPE_CHECKING, Any
from xphi.arch.model.conv.event import N_CHAR_PREVIEW, Event, LLMConvertibleEvent
