# fiber.agent.engine.event.message
## @lineage: fiber.agent.client.event.message
## @lineage: surgent.conv.event.message
## @lineage: conv.event.message
## @lineage: space.event.message
## @lineage: runtime.event.message
## @lineage: agent.llm.driver.event.message
## @lineage: ator.driver.llm.event.message
## @lineage: agent.space.conv.event.llm.message
import copy
