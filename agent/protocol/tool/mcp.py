# agent.protocol.tool.mcp
## @lineage: engine.protocol.tool.mcp
## @lineage: engine.protocol.atoa.schema.tool.mcp
## @lineage: phi.agent.atoa.schema.tool.mcp
## @lineage: agent.atoa.schema.tool.mcp
