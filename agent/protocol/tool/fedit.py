# agent.protocol.tool.fedit
## @lineage: engine.protocol.tool.fedit
...
## @lineage: phi.agent.action.tool.fedit
## @lineage: swarm.phi.action.tool.fedit
## @lineage: agent.action.tool.fedit
## @lineage: gov.action.tool.fedit
...
from engine.atoa.action.builder import DeclaredResources, ActionAnnotations, ActionDefinition
...
class FileEditorTool(ActionDefinition[FileEditorAction, FileEditorObservation]):
    ...
    def create(cls, conv_state: "ConversationState") -> Sequence["FileEditorTool"]:
        from engine.tool.fedit.executor import FileEditorExecutor
