# agent.protocol.tool.browser
## @lineage: engine.protocol.tool.browser
...
## @lineage: phi.agent.action.tool.browser
## @lineage: swarm.phi.action.tool.browser
## @lineage: agent.action.tool.browser
## @lineage: gov.action.tool.browser
