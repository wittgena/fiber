...
## @lineage: atoa.executor.parallel
## @lineage: bound.executor.parallel
## @lineage: xor.executor.parallel
from __future__ import annotations
from collections.abc import Callable, Sequence, Generator
from concurrent.futures import ThreadPoolExecutor
from contextlib import contextmanager
from typing import TYPE_CHECKING, Final, Protocol, runtime_checkable
from agent.atoa.disc.event.llm.observation import AgentErrorEvent
import threading
from agent.gov.store.fifo import FIFOLock

if TYPE_CHECKING:
    from agent.eco.event.base import Event
    from agent.atoa.disc.event.llm_convertible import ActionEvent
    from agent.atoa.action.definition import DeclaredResources, ActionDefinition
