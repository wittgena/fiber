# agent.disc.memory.codon.registry
## @lineage: gov.disc.memory.codon.registry
...
class AtorDefinition(BaseModel):
    ...
    def get_confirmation_policy(self) -> ConfirmationPolicyBase | None:
        ...
        if self.permission_mode == "always_confirm":
            from atoa.secure.security.confirm import AlwaysConfirm
        ...
        if self.permission_mode == "confirm_risky":
            from atoa.secure.security.confirm import ConfirmRisky
            return ConfirmRisky()
