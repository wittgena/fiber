# fiber.agent.client.engine.tmux.pool
## @lineage: surgent.topos.protocol.tmux.pool
## @lineage: surgent.agent.protocol.tmux.pool
## @lineage: surgent.agent.executor.tmux.pool
## @lineage: surgent.space.terminal.tmux.pool
## @lineage: space.terminal.tmux.pool
...
from fiber.agent.client.engine.protocol.builder import sanitized_env
...
from fiber.agent.client.engine.tmux.interface import TmuxTerminal
...
class TmuxPanePool:
    ...
    def initialize(self) -> None:
        ...
        # [개선] 다중 스레드 환경에서 지연 초기화가 동시에 호출되는 것을 방지하기 위해 Lock 적용
        with self._lock:
