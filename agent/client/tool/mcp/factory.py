# fiber.agent.client.tool.mcp.factory
...
from fiber.agent.client.engine.protocol.builder import AsyncExecutorProtocol
from fiber.agent.client.tool.mcp.exception import MCPError, MCPTimeoutError
from fiber.agent.client.tool.schema.action import Action, Observation, Schema
from fiber.agent.client.tool.schema.builder import ActionAnnotations, ActionDefinition
from fiber.agent.client.tool.schema.executor import ActionExecutor
from fiber.agent.client.tool.schema.mcp import MCPAction, MCPObservation
...
class MCPClient(AnchorClient):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if executor is None:
            from fiber.agent.client.engine.protocol.builder import executor_factory
