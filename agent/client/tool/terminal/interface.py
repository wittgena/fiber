# fiber.agent.client.tool.terminal.interface
## @lineage: surgent.engine.terminal.interface
## @lineage: surgent.agent.engine.terminal.interface
## @lineage: surgent.space.terminal.runtime.interface
## @lineage: space.terminal.runtime.interface
## @lineage: runtime.terminal.interface
