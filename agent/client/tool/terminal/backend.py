# fiber.agent.client.tool.terminal.backend
## @lineage: surgent.engine.terminal.backend
## @lineage: surgent.agent.engine.terminal.backend
## @lineage: surgent.space.terminal.backend
## @lineage: space.terminal.backend
import os
import platform
import re
import shutil
