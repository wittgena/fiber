# fiber.agent.client.tool.schema.terminal
## @lineage: surgent.conv.schema.terminal
import os
...
from fiber.agent.client.tool.schema.builder import DeclaredResources, ActionAnnotations, ActionDefinition
...
class TerminalTool(ActionDefinition[TerminalAction, TerminalObservation]):
    ...
    def create(
        ...
        from fiber.agent.client.engine.protocol.terminal import TerminalExecutor
