# fiber.agent.client.tool.action.resolver
...
from fiber.agent.client.tool.action.factory import MessageIntent, TopologicalIntent, CoreAction, ActionProxy, build_action
...
def _handle_bridge(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    from fiber.agent.conver.status import ConverStatus
    from fiber.agent.client.event.observation import ObservationEvent
