# agent.runtime.terminal.session.builder
...
from agent.runtime.protocol.tool.terminal import TerminalObservation
from agent.runtime.protocol.terminal.context import (
    ExecutionContext,
    ExecutionEngine,
    ExecutionMiddleware,
)
...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from agent.runtime.terminal.backend import SubprocessTerminal
