# agent.runtime.executor.command
## @lineage: engine.executor.command
## @lineage: phi.executor.command
## @lineage: phi.engine.executor.command
## @lineage: swarm.engine.executor.command
## @lineage: swarm.mesh.engine.executor.command
## @lineage: mesh.engine.executor.command
## @lineage: agent.executor.command
## @lineage: atoa.agent.executor.command
## @lineage: atoa.command
import os
import shlex
import subprocess
import sys
...
def execute_command(
    ...
    logger.info("$ %s", redact_string(cmd_str))
