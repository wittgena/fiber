# agent.runtime.executor.base
## @lineage: engine.executor.base
## @lineage: phi.executor.base
## @lineage: phi.engine.executor.base
## @lineage: swarm.engine.executor.base
## @lineage: swarm.mesh.engine.executor.base
## @lineage: mesh.engine.executor.base
## @lineage: agent.executor.base
## @lineage: atoa.agent.executor.base
## @lineage: atoa.executor.base
## @lineage: arch.xor.proto.asyncer
import atexit
import inspect
import threading
import weakref
