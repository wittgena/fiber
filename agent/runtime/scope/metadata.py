# agent.runtime.scope.metadata
## @lineage: agent.topos.scope.metadata
## @lineage: actor.topos.scope.metadata
## @lineage: topos.scope.metadata
## @lineage: topos.bound.scope.metadata
