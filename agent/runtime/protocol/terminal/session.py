# agent.runtime.protocol.terminal.session
...
from agent.runtime.protocol.terminal.interface import TerminalInterface, TerminalSessionBase
from agent.runtime.protocol.terminal.context import ExecutionEngine, ExecutionContext
