# fiber.agent.conver.protocol.view
## @lineage: surgent.topos.protocol.command.view
## @lineage: surgent.agent.protocol.command.view
## @lineage: surgent.space.runtime.command.view
## @lineage: space.runtime.command.view
## @lineage: runtime.command.view
## @lineage: agent.loop.conv.view
