# fiber.agent.conver.protocol.stats
## @lineage: surgent.topos.protocol.command.stats
## @lineage: surgent.agent.protocol.command.stats
## @lineage: surgent.space.runtime.command.stats
## @lineage: space.runtime.command.stats
## @lineage: runtime.command.stats
## @lineage: agent.loop.conv.stats
from typing import Any
from pydantic import BaseModel, Field, PrivateAttr, model_serializer

from fiber.llm.driver.registry import RegistryEvent
