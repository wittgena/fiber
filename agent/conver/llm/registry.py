# agent.conver.llm.registry
## @lineage: phi.conver.llm.registry
## @lineage: swarm.conver.llm.registry
## @lineage: swarm.engine.llm.registry
## @lineage: agent.driver.llm.registry
## @lineage: agent.registry
