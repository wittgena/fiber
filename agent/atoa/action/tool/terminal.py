# agent.atoa.action.tool.terminal
...
from agent.atoa.action.definition import DeclaredResources, ActionAnnotations, ActionDefinition
...
class TerminalTool(ActionDefinition[TerminalAction, TerminalObservation]):
    ...
    def create(
        ...
        from agent.gov.tool.terminal.executor import TerminalExecutor
