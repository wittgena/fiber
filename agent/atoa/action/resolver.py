...
from agent.atoa.action.factory import MessageIntent, TopologicalIntent, CoreAction, ActionProxy, build_action
...
def _handle_bridge(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    ...
    from agent.conv.context.command import TransitionStatus, UpdateAgentState
