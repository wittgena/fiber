# agent.atoa.disc.event.llm.observation
## @lineage: atoa.agent.disc.event.llm.observation
from typing import Literal
from pydantic import Field
from rich.text import Text
from agent.eco.event.base import N_CHAR_PREVIEW, LLMConvertibleEvent
from agent.eco.event.types import EventID, SourceType, ToolCallID
from agent.eco.action.message import Message, TextContent, content_to_str
