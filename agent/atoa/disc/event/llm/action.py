# agent.atoa.disc.event.llm.action
## @lineage: atoa.agent.disc.event.llm.action
## @lineage: atoa.disc.event.llm.action
## @lineage: agent.disc.event.llm.action
from collections.abc import Sequence
from typing import TYPE_CHECKING
from pydantic import Field
from rich.text import Text
from agent.atoa.disc.schema.reflect import ReflectorResult
from agent.eco.event.base import N_CHAR_PREVIEW, EventID, LLMConvertibleEvent
from agent.eco.event.types import SourceType, ToolCallID
from agent.eco.action.message import (
    Message,
    MessageToolCall,
    ReasoningItemModel,
...
from agent.gov.security.eval import SecurityRisk
from agent.atoa.disc.schema.action import Action
