# agent.atoa.disc.schema.setting
...
from agent.eco.residue.convset import (
...
from agent.atoa.disc.schema.metadata import SettingsSchema, SettingsValueType, SettingsChoiceValue, SettingsChoice
