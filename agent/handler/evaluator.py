# agent.handler.evaluator
## @lineage: atoa.agent.handler.evaluator
## @lineage: agent.topos.handler.evaluator
## @lineage: atoa.topos.handler.evaluator
## @lineage: atoa.agent.action.evaluator
from __future__ import annotations
from typing import TYPE_CHECKING
from atoa.mesh.schema.reflect import ReflectorResult, ReflectorBase
