...
"""
import os
from gateway.adapter.switch.params import LITELLM_CONVERT_SWITCH
...
if not LITELLM_CONVERT_SWITCH:
    try:
        from resolver.model.support import get_supported_openai_params, supports_vision
