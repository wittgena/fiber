# gateway.cost.policy
## @lineage: bound.eco.cost.policy
## @lineage: bound.proxy.eco.cost.policy
import time
from typing import TYPE_CHECKING, Any, Callable, Dict, Literal, Optional, Tuple, Union, cast
from pydantic import BaseModel
from resolver.model.config.resolver import config as global_config
from resolver.model.config.constants import DEFAULT_REPLICATE_GPU_PRICE_PER_SECOND
from eco.legacy.types import CostPerToken
