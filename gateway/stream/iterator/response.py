# gateway.stream.iterator.response
## @lineage: bound.stream.iterator.response
## @lineage: bound.transport.stream.iterator.response
## @lineage: bound.surface.stream.iterator.response
...
from gateway.adapter.mapper.key import adapt_payload_for_external_litellm, get_legacy_key
from eco.legacy.types import EmbeddingResponse, HiddenParams, ModelResponse, TranscriptionResponse
from resolver.model.config.constants import LITELLM_DETAILED_TIMING
from gateway.adapter.tosync import SyncStreamAdapter

import eco.legacy.openai.types as openai_types

from resolver.model.config.resolver import config
from resolver.model.config.constants import LITELLM_MAX_STREAMING_DURATION_SECONDS, STREAM_SSE_DONE_STRING
from eco.legacy.openai.types import ResponsesAPIStreamEvents
from eco.legacy.types import CallTypes
from resolver.model.config.response import BaseResponsesAPIConfig
from bound.executor.legacy import executor
from gateway.adapter.header import process_response_headers
from resolver.model.api.base import get_api_base
