# gateway.stream.iterator.mcp
## @lineage: bound.stream.iterator.mcp
## @lineage: bound.transport.stream.iterator.mcp
## @lineage: bound.surface.stream.iterator.mcp
## @lineage: bound.transport.stream.mcp
from typing import TYPE_CHECKING, Any, Dict, List, Optional, Union, cast
from starlette.datastructures import Headers

from gateway.adapter.switch.params import ResponsesAPIResponse, ResponsesAPIStreamingResponse
...
from eco.mcp.parser.header import MCPHeaderParser
from eco.mcp.parser.payload import MCPPayloadParser
from eco.mcp.event.call import create_mcp_call_events
