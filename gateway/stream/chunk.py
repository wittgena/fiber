...
## @lineage: bound.stream.chunk
## @lineage: bound.transport.stream.chunk
## @lineage: bound.surface.stream.chunk
...
from gateway.stream.processor.builder import ChunkBuilderProcessor
from gateway.adapter.switch.params import Choices, Message, ModelResponse, Usage
