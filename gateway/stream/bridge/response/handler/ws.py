# gateway.stream.bridge.response.handler.ws
## @lineage: bound.bridge.response.handler.ws
## @lineage: bound.transport.bridge.response.handler.ws
## @lineage: bound.bridge.transport.response.handler.ws
## @lineage: bound.transport.response.handler.ws
## @lineage: bound.transport.handler.ws
## @lineage: bound.transport.ws
...
from resolver.model.config.constants import REALTIME_WEBSOCKET_MAX_MESSAGE_SIZE_BYTES
