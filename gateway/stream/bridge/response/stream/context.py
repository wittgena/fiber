# gateway.stream.bridge.response.stream.context
## @lineage: bound.bridge.response.stream.context
## @lineage: bound.transport.bridge.response.stream.context
## @lineage: bound.bridge.transport.response.stream.context
