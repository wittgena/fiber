# fiber.infra.gateway.quarantine
## @lineage: fiber.agent.gateway.quarantine
## @lineage: fiber.agent.infra.bridge.quarantine
## @lineage: fiber.infra.agent.bridge.quarantine
