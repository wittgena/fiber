# fiber.infra.worker.quarantine
import json
import logging
from typing import Any, Dict

log = logging.getLogger("worker.quarantine")

# =====================================================================
# 1. Declarative Ruleset (선언적 규칙 사전)
# =====================================================================
QUARANTINE_RULES = {
    "legacy-01": {
...
# =====================================================================
# 2. Payload Traverser (안전한 JSON 트리 조작기)
# =====================================================================
