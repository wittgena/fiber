# ops.opt.thch
## @lineage: void.extime.opt.thch
## @lineage: fiber.opt.thch
## @lineage: fiber.xor.adapter.thch
import json
import inspect
...
from void.extime.opt.module.meta import Module
from void.extime.opt.manifold.cot import ChainOfThought 

from void.extime.opt.sign.field import InputField, OutputField
from void.extime.opt.sign.signature import Signature
