...
from ext.router.llm.model.types.block import ChatMessage, MessageRole, TextBlock
from ext.router.adapter.pydantic import (
    BaseModel,
    GetCoreSchemaHandler,
    GetJsonSchemaHandler,
)
from ext.router.adapter.pydantic import CoreSchema, core_schema
