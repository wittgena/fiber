# engine.atoa.context.state
## @lineage: engine.protocol.atoa.context.state
## @lineage: phi.agent.atoa.context.state
## @lineage: agent.atoa.context.state
...
from engine.atoa.event.llm.observation import (
    AgentErrorEvent,
    ObservationEvent,
...
from engine.atoa.conv.types import ConversationCallbackType, ConversationID, ConversationTags
...
from engine.atoa.context.io import IOManager
    ...
    def __setattr__(self, name, value):
        ...
        if old is _sentinel or old != value:
            ...
            if callback is not None and old is not _sentinel:
                try:
                    from engine.atoa.event.conv import ConversationStateUpdateEvent
