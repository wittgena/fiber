# engine.atoa.action.resolver
## @lineage: engine.protocol.action.resolver
## @lineage: phi.agent.action.resolver
## @lineage: agent.action.resolver
## @lineage: atoa.agent.action.resolver
## @lineage: swarm.phi.action.resolver
import json
...
from engine.atoa.action.factory import MessageIntent, TopologicalIntent, CoreAction, ActionProxy, build_action
...
def _handle_bridge(action: Any, conv: "ProtoConv | None", ObsClass: type[Observation]) -> Observation:
    from agent.state.context.status import ConverStatus
    from engine.atoa.event.llm.observation import ObservationEvent
