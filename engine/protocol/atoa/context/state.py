# engine.protocol.atoa.context.state
...
from engine.protocol.atoa.event.llm.observation import (
    AgentErrorEvent,
    ObservationEvent,
    ...
    def __setattr__(self, name, value):
        ...
        if old is _sentinel or old != value:
            ...
            if callback is not None and old is not _sentinel:
                try:
                    from engine.protocol.atoa.event.conv import ConversationStateUpdateEvent
