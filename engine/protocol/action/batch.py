# engine.protocol.action.batch
## @lineage: phi.agent.action.batch
## @lineage: agent.action.batch
## @lineage: atoa.agent.action.batch
from __future__ import annotations
from collections.abc import Callable
from dataclasses import dataclass, field

from engine.protocol.atoa.conv.types import ConversationCallbackType
