# engine.parser.toolcall
## @lineage: engine.atoa.conv.parser.toolcall
## @lineage: engine.protocol.atoa.conv.parser.toolcall
## @lineage: phi.agent.atoa.conv.parser.toolcall
## @lineage: agent.atoa.conv.parser.toolcall
## @lineage: atoa.agent.parser.toolcall
## @lineage: phi.agent.parser.toolcall
## @lineage: bound.parser.conv.toolcall
## @lineage: gov.atoa.parser.conv.toolcall
import contextlib
import json
import logging
import re
