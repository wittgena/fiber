# engine.scope.manager
## @lineage: dphi.topos.scope.manager
## @lineage: agent.runtime.scope.manager
## @lineage: agent.topos.scope.manager
## @lineage: actor.topos.scope.manager
...
from engine.scope.surface.registry import get_surface_class
