# engine.scope.setting
## @lineage: dphi.topos.scope.setting
## @lineage: agent.runtime.scope.setting
## @lineage: agent.topos.scope.setting
## @lineage: actor.topos.scope.setting
## @lineage: topos.scope.setting
...
from engine.scope.metadata import SettingsSchema, SettingsValueType, SettingsChoiceValue, SettingsChoice
