...
from engine.protocol.atoa.schema.tool.schema.browser import BrowserAction, BrowserObservation

if sys.platform == "win32":
    from engine.tool.browser.window import WindowsBrowserExecutor
else:
    from engine.tool.browser.executor import BrowserExecutor
