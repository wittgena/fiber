...
from bound.transport.proxy.pypi.client import PypiMCPClient
...
class SecurityWarden:
    ...
    async def _fetch_dynamic_token(self) -> str:
        ...
        try:
            ...
            from xphi.proxy.auth.client.provider import ClientCredentialsOAuthProvider
...
def _ensure_proxy_active(registry_url: str) -> PypiMCPClient:
    ...
    try:
        import bound.transport.proxy.pypi.server as proxy_server
