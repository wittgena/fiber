# anchor.phase.reflect.server.auth.client.provider
## @lineage: bound.reflect.server.auth.client.provider
## @lineage: xphi.reflect.server.auth.client.provider
## @lineage: xphi.reflect.auth.client.provider
## @lineage: xphi.proxy.auth.client.provider
## @lineage: proxy.auth.client.provider
import time
import warnings
