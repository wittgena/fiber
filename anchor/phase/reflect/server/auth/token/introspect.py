# anchor.phase.reflect.server.auth.token.introspect
## @lineage: bound.reflect.server.auth.token.introspect
## @lineage: xphi.reflect.server.auth.token.introspect
## @lineage: xphi.reflect.auth.token.introspect
## @lineage: xphi.proxy.auth.token.introspect
## @lineage: xphi.xor.auth.token.introspect
