...
from anchor.provider.router.config import get_provider_info
...
def get_model_info(
    ...
    """
    @desc: Retrieves metadata and configuration details for a given model in real-time.
    @note: Cache is intentionally removed as dict lookups are O(1) and avoid registry overhead.
    """
    from anchor.provider.registry import lookup_base_model_info
