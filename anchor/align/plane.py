# anchor.align.plane
## @lineage: meta.flow.align.anchor.imports
import os
import sys
import argparse
...
from arch.bound.trans.imports.aligner import RelativeImportAligner
from phase.runtime.cli.executor import CliTaskAdapter, parse_local, dispatch_cli
from phase.bind.resolver import find_current_self
from watcher.plane.emitter import get_emitter

log = get_emitter("anchor.imports", phase="SYSTEM")
...
def entry_task(args):
    ...
    # [변경] --repo 대신 --path 사용 (좁은 범위 지정 가능)
    ...
    # [변경] SELF_ROOT 의존성 제거, 입력받은 경로를 절대 경로로 안전하게 치환
...
def main():
    ...
    if bound_args.local:
        ...
        dispatch_cli("anchor.imports", entry_task, __file__)
