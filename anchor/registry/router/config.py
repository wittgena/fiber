# anchor.registry.router.config
## @lineage: anchor.provider.router.config
## @lineage: bound.router.provider.config
...
from bound.surface.bridge.channel.param.format import BaseLLMModelInfo
