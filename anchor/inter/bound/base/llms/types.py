# anchor.inter.bound.base.llms.types
...
from anchor.inter.bound.schema import ImageDocument
from anchor.inter.bound.utils import get_tokenizer, resolve_binary
...
class BaseContentBlock(ABC, BaseModel):
    ...
    def get_template_vars(self) -> list[str]:
        ...
        """
        from anchor.inter.bound.prompts.utils import get_template_vars
    ...
    def format_vars(self, **kwargs: Any) -> "BaseContentBlock":
        ...
        For that to work, the validation on those fields would need to be updated though.
        """
        from anchor.inter.bound.prompts.utils import format_string
...
class TextBlock(BaseContentBlock):
    ...
    async def asplit(
        ...
        from anchor.inter.bound.node_parser import TokenTextSplitter
