# anchor.surface.hf.embedding.optimum.base
from typing import Any, List, Optional
from transformers import AutoTokenizer

from anchor.surface.hf.utils import format_query, format_text
from bound.adapter.llama.base.embeddings.base import DEFAULT_EMBED_BATCH_SIZE, BaseEmbedding
    ...
    def __init__(
        ...
        if model is None:
            try:
                ...
                raise ImportError(
                    "OptimumEmbedding 런타임 엔진 엔진이 누락되었습니다.\n"
                    "실제 구동을 원하시면 다음 명령어로 엔진을 설치하십시오:\n"
                    "`pip install optimum[onnxruntime]`"
                )
            model = ORTModelForFeatureExtraction.from_pretrained(folder_name)
