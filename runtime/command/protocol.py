...
## @lineage: agent.loop.runtime.protocol.conv
from abc import ABC, abstractmethod
from collections.abc import Sequence
from typing import TYPE_CHECKING, Protocol, Any

from fiber.runtime.action.types import ConversationID, ConversationTags, ConversationCallbackType
...
from fiber.runtime.command.conv import StateCommand
