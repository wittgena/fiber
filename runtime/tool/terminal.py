# runtime.tool.terminal
## @lineage: agent.loop.runtime.protocol.tool.terminal
## @lineage: agent.runtime.protocol.tool.terminal
## @lineage: ator.driver.protocol.tool.terminal
## @lineage: agent.protocol.tool.terminal
## @lineage: agent.space.conv.protocol.tool.terminal
import os
...
from fiber.dphi.space.action.builder import DeclaredResources, ActionAnnotations, ActionDefinition
from fiber.dphi.space.action.message import ImageContent, TextContent
...
class TerminalTool(ActionDefinition[TerminalAction, TerminalObservation]):
    ...
    def create(
        ...
        from fiber.dphi.space.terminal.executor import TerminalExecutor
