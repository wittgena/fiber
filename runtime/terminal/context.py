# runtime.terminal.context
## @lineage: agent.loop.runtime.protocol.terminal.context
## @lineage: agent.runtime.protocol.terminal.context
...
if TYPE_CHECKING:
    ...
    from fiber.runtime.terminal.session import TerminalSessionBase
