...
from tenant.model.config.base import BaseConfig
from tenant.model.config.resolver import config
from tenant.model.protype import ProviderTypes
from bound.client import AsyncHTTPClient
from bound.client import HTTPClient
from bound.client import get_client
...
class CompletionHandler:
    ...
    def _handle_error(self, e: Exception, provider_config: BaseConfig):
        ...
        if provider_config is None:
            from tenant.model.config.base import BaseLLMException
