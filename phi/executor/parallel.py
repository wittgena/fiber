# phi.executor.parallel
## @lineage: phi.engine.executor.parallel
## @lineage: swarm.engine.executor.parallel
## @lineage: swarm.mesh.engine.executor.parallel
## @lineage: mesh.engine.executor.parallel
## @lineage: agent.executor.parallel
...
from topos.state.store.fifo import FIFOLock

if TYPE_CHECKING:
    from agent.atoa.conv.event import Event
    from agent.atoa.event.llm_convertible import ActionEvent
    from agent.action.builder import DeclaredResources, ActionDefinition
