# phi.executor.engine.builder.session
...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from phi.executor.terminal.tmux import (
                TmuxTerminal,
            )
            ...
            from phi.executor.terminal.backend import (
                SubprocessTerminal,
            )
    ...
    if system == "Windows":
        ...
        if _is_tmux_available():
            ...
            from phi.executor.terminal.backend import SubprocessTerminal
            _tmux_warning = (
