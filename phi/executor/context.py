# phi.executor.context
## @lineage: phi.engine.executor.context
## @lineage: swarm.engine.executor.context
...
if TYPE_CHECKING:
    ...
    from phi.executor.terminal.session import TerminalSessionBase
