...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from phi.engine.terminal.tmux import (
                TmuxTerminal,
            )
            ...
            from phi.engine.terminal.backend import (
                SubprocessTerminal,
            )
    ...
    if system == "Windows":
        ...
        if _is_tmux_available():
            ...
            from phi.engine.terminal.backend import SubprocessTerminal
            _tmux_warning = (
