# phi.runtime.tool.browser.factory
...
if sys.platform == "win32":
    from phi.runtime.tool.browser.window import WindowsBrowserExecutor
else:
    from phi.runtime.tool.browser.executor import BrowserExecutor
