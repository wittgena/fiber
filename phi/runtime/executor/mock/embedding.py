# phi.runtime.executor.mock.embedding
## @lineage: tenant.action.mock.embedding
## @lineage: eco.tenant.action.mock.embedding
## @lineage: topos.tester.mock.embedding
## @lineage: void.topos.tester.mock.embedding
"""
...
from tenant.switch.params import EmbeddingResponse
