# phi.runtime.executor.mock.completion
## @lineage: tenant.action.mock.completion
## @lineage: eco.tenant.action.mock.completion
## @lineage: topos.tester.mock.completion
"""
...
from tenant.switch.params import ModelResponse, Choices, Message
...
def create_mock_tool_call(
    ...
    """
    import json
    from tenant.switch.params import ChatCompletionMessageToolCall, Function
