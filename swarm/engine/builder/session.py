...
def create_terminal_session(
    ...
    if terminal_type:
        ...
        if terminal_type == "tmux":
            ...
            from swarm.engine.terminal.tmux import (
                TmuxTerminal,
            )
            ...
            from swarm.engine.terminal.backend import (
                SubprocessTerminal,
            )
    ...
    if system == "Windows":
        ...
        if _is_tmux_available():
            ...
            from swarm.engine.terminal.backend import SubprocessTerminal
            _tmux_warning = (
