# swarm.warden.token.introspect
## @lineage: topos.warden.token.introspect
...
## @lineage: xphi.xor.secure.auth.token.introspect
## @lineage: anchor.phase.reflect.server.auth.token.introspect
